...
!(function (e, t) {
  ...
  function n(e, n) {
    ...
    t(e, n),
      (e.prototype =
        null === n ? Object.create(n) : ((s.prototype = n.prototype), new s()));
  }
  var s = function () {
    return (
      (s =
  ...
  var i,
    ...
    m = u ? navigator.userAgent : "",
    p = u ? navigator.platform : "",
    v = u ? navigator.maxTouchPoints : 0,
    f = m && m.match(/Android|iPhone|iPad|iPod|Windows Phone|Windows|MSIE/i),
    g = m && /Safari/.test(m);
  /Android/i.test(f)
    ? ((i = "android"),
      (r = m.match(/Android\s+([\d.]+)/i)),
      (d = !0),
      r && (h = r[0].replace("Android ", "").split(".")))
    : /iPhone|iPad|iPod/i.test(f) ||
      /iPhone|iPad|iPod/i.test(p) ||
      ("MacIntel" === p && v > 1)
    ? ((i = "ios"),
      (r = m.match(/OS\s+([\d_]+)/i)),
      (d = !0),
      r && (h = r[0].replace(/_/g, ".").replace("OS ", "").split(".")))
    : /Windows Phone/i.test(f)
    ? ((i = "wp"), (d = !0))
    : /Windows|MSIE/i.test(f) && (i = "windows"),
    (o = +h[0]),
    (l = +h[1]);
  var y = {},
    b = {},
  ...
  function w() {
    ...
    for (var s in ((t =
      "android" === i
        ...
        : "ios"),
    D)) {
      if (D[s].baseTheme === t && !1 !== D[s].auto && s !== t + "-dark") {
        e = s;
        break;
      }
      s === t ? (e = s) : n || (n = s);
  ...
  function T(e, t, n) {
    var a = D[t];
    (D[e] = s({}, a, { auto: n, baseTheme: t })), (C.theme = w());
  }
  var x = { majorVersion: o, minorVersion: l, name: i },
    S =
    ...
    I = { clearIcon: N, labelStyle: "inline" };
  (D.ios = {
    Calendar: { nextIconH: M, nextIconV: E, prevIconH: S, prevIconV: L },
    Checkbox: { position: "end" },
    Datepicker: { clearIcon: N, display: "bottom" },
    Dropdown: I,
    Eventcalendar: {
      chevronIconDown: E,
      nextIconH: M,
  ...
  var ee = u ? document : H,
    te = u ? window : H,
    ne = ["Webkit", "Moz"],
    se = ee && ee.createElement("div").style,
    ae = ee && ee.createElement("canvas"),
    ie = ae && ae.getContext("2d"),
    re = te && te.CSS,
    oe = re && re.supports,
    le = {},
    ce =
    ...
    he =
      (te && te.cancelAnimationFrame) ||
      function (e) {
        clearTimeout(e);
      },
    de = se && se.animationName !== H,
    ue = "ios" === i && !g,
    _e = ue && te && te.webkit && te.webkit.messageHandlers,
    me = (se && se.touchAction === H) || (ue && !_e),
    pe = (function () {
      if (!se || se.transform !== H) return "";
      for (var e = 0, t = ne; e < t.length; e++) {
        var n = t[e];
        if (se[n + "Transform"] !== H) return n;
      }
      return "";
    })(),
    ve = pe ? "-" + pe.toLowerCase() + "-" : "";
  oe && oe("(transform-style: preserve-3d)");
  var fe = oe && (oe("position", "sticky") || oe("position", "-webkit-sticky"));
  function ge(e, t, n, s) {
  ...
  function be(e) {
    return u ? (e && e.ownerDocument ? e.ownerDocument : ee) : H;
  }
  function De(e, t) {
    return parseFloat(getComputedStyle(e)[t] || "0");
  }
  function Ce(e) {
    return e.scrollLeft !== H ? e.scrollLeft : e.pageXOffset;
  }
  function ke(e) {
    return e.scrollTop !== H ? e.scrollTop : e.pageYOffset;
  }
  function we(e) {
    return u
  ...
  function Te(e, t) {
    var n = getComputedStyle(e),
      s = (pe ? n[pe + "Transform"] : n.transform).split(")")[0].split(", ");
    return +(t ? s[13] || s[5] : s[12] || s[4]) || 0;
  }
  function xe(e) {
    if (le[e]) return le[e];
    if (!ie) return "#fff";
    (ie.fillStyle = e), ie.fillRect(0, 0, 1, 1);
    var t = ie.getImageData(0, 0, 1, 1).data,
      n = 0.299 * +t[0] + 0.587 * +t[1] + 0.114 * +t[2] < 130 ? "#fff" : "#000";
    return (le[e] = n), n;
  }
  function Se(e, t, n, s, a, i) {
    var r = Math.min(1, (+new Date() - t) / 468),
      o = 0.5 * (1 - Math.cos(Math.PI * r)),
      l = K(n + (s - n) * o);
    a ? (e.scrollLeft = l) : (e.scrollTop = l),
      l !== s
        ? ce(function () {
            Se(e, t, n, s, a, i);
          })
  ...
  function Ee(e, t, n, s, a, i) {
    (t = Math.max(0, K(t))),
      a && s && (t = -t),
      n
        ? Se(e, +new Date(), s ? e.scrollLeft : e.scrollTop, t, s, i)
        : (s ? (e.scrollLeft = t) : (e.scrollTop = t), i && i());
  }
  function Me(e) {
    if (ee && e) {
      var t = ee.createElement("div");
  ...
  function Le(e) {
    var t = e.getBoundingClientRect(),
      ...
      s = we(e);
    return s !== H && ((n.top += ke(s)), (n.left += Ce(s))), n;
  }
  function Ne(e, t) {
  ...
  var Ye = {
    _catchError: function (e, t) {
      for (var n, s, a; (t = t._parent); )
        if ((n = t._component) && !n._processingException)
          try {
            if (
              ((s = n.constructor) &&
                null != s.getDerivedStateFromError &&
                (n.setState(s.getDerivedStateFromError(e)), (a = n._dirty)),
              null != n.componentDidCatch &&
                (n.componentDidCatch(e), (a = n._dirty)),
              a)
            )
  ...
  function Ue(e, t, n) {
    var s,
      ...
      r = {};
    for (i in t)
      "key" == i ? (s = t[i]) : "ref" == i ? (a = t[i]) : (r[i] = t[i]);
    ...
    return Ae(e, r, s, a, null);
  }
  function Ae(e, t, n, s, a) {
    var i = {
      type: e,
      props: t,
      key: n,
      ...
      _hydrating: null,
      constructor: void 0,
      _original: null == a ? ++Ye._vnodeId : a,
    };
    return null != Ye.vnode && Ye.vnode(i), i;
  }
  function Fe(e) {
    return e.children;
  }
  ...
  function Ve(e, t) {
    if (null == t)
      return e._parent
        ? Ve(e._parent, e._parent._children.indexOf(e) + 1)
        : null;
    for (var n; t < e._children.length; t++)
      if (null != (n = e._children[t]) && null != n._dom) return n._dom;
    return "function" == typeof e.type ? Ve(e) : null;
  }
  function Be(e) {
    var t = e._vnode,
      n = t._dom,
  ...
  (We.prototype.setState = function (e, t) {
    ...
    (n =
      null != this._nextState && this._nextState !== this.state
        ? this._nextState
        : (this._nextState = ze({}, this.state))),
      "function" == typeof e && (e = e(ze({}, n), this.props)),
      e && ze(n, e),
      null != e &&
        this._vnode &&
        (t && this._renderCallbacks.push(t), Ke(this));
  }),
    (We.prototype.forceUpdate = function (e) {
      this._vnode &&
        ((this._force = !0), e && this._renderCallbacks.push(e), Ke(this));
    }),
  ...
  var je,
    ...
    Ge =
      "function" == typeof Promise
        ...
        : setTimeout;
  function Ke(e) {
    ((!e._dirty && (e._dirty = !0) && qe.push(e) && !Je._rerenderCount++) ||
      je !== Ye.debounceRendering) &&
      ((je = Ye.debounceRendering) || Ge)(Je);
  }
  function Je() {
    for (var e; (Je._rerenderCount = qe.length); )
      (e = qe.sort(function (e, t) {
  ...
  function Ze(e, t, n, s, a, i, r, o, l, c) {
    var h,
      d,
      u,
      _,
        ...
        (_ =
          null == (_ = t[h]) || "boolean" == typeof _
            ...
            : "string" == typeof _ ||
              "number" == typeof _ ||
              "bigint" == typeof _
            ? (n._children[h] = Ae(null, _, null, null, _))
            : Array.isArray(_)
            ? (n._children[h] = Ae(Fe, { children: _ }, null, null, null))
            : _._depth > 0
            ? (n._children[h] = Ae(_.type, _.props, _.key, null, _._original))
            : (n._children[h] = _))
      ) {
        if (
          ((_._parent = n),
          (_._depth = n._depth + 1),
          null === (u = f[h]) || (u && _.key == u.key && _.type === u.type))
        )
          f[h] = void 0;
        else
          for (d = 0; d < g; d++) {
            if ((u = f[d]) && _.key == u.key && _.type === u.type) {
              f[d] = void 0;
              break;
            }
            u = null;
          }
        at(e, _, (u = u || He), a, i, r, o, l, c),
          (m = _._dom),
          (d = _.ref) &&
            u.ref != d &&
            (v || (v = []),
            u.ref && v.push(u.ref, null, _),
            v.push(d, _._component || m, _)),
          null != m
            ? (null == p && (p = m),
              "function" == typeof _.type &&
              null != _._children &&
              _._children === u._children
                ? (_._nextDom = l = $e(_, l, e))
                : (l = Qe(e, _, u, f, m, l)),
              c || "option" !== n.type
                ? "function" == typeof n.type && (n._nextDom = l)
                : (e.value = ""))
            : l && u._dom == l && l.parentNode != e && (l = Ve(u));
      }
    for (n._dom = p, h = g; h--; )
      null != f[h] &&
        ("function" == typeof n.type &&
          ...
          (n._nextDom = Ve(s, h + 1)),
        ot(f[h], f[h]));
    if (v) for (h = 0; h < v.length; h++) rt(v[h], v[++h], v[++h]);
  }
  function $e(e, t, n) {
      ...
      a &&
        ...
        (t =
          "function" == typeof a.type
            ? $e(a, t, n)
            : Qe(n, a, a, e._children, a._dom, t)));
    }
    return t;
  }
  function Qe(e, t, n, s, a, i) {
    var r;
    if (void 0 !== t._nextDom) (r = t._nextDom), (t._nextDom = void 0);
    else if (null == n || a != i || null == a.parentNode)
      e: if (null == i || i.parentNode !== e) e.appendChild(a), (r = null);
      else {
        for (var o = i, l = 0; (o = o.nextSibling) && l < s.length; l += 2)
          if (o == a) break e;
        e.insertBefore(a, i), (r = i);
      }
    return (i = void 0 !== r ? r : a.nextSibling);
  }
  function et(e, t, n) {
    "-" === t[0]
      ? e.setProperty(t, n)
    ...
    e: if ("style" === t)
      if ("string" == typeof n) e.style.cssText = n;
        ...
        if (("string" == typeof s && (e.style.cssText = s = ""), s))
          for (t in s) (n && t in n) || et(e.style, t, "");
        if (n) for (t in n) (s && n[t] === s[t]) || et(e.style, t, n[t]);
      }
    else if ("o" === t[0] && "n" === t[1])
      if (
  ...
  function nt(e) {
    this._listeners[e.type + !1](Ye.event ? Ye.event(e) : e);
  }
  function st(e) {
    this._listeners[e.type + !0](Ye.event ? Ye.event(e) : e);
  }
  function at(e, t, n, s, a, i, r, o, l) {
    var c,
      h = t.type;
      ...
      e: if ("function" == typeof h) {
        ...
        if (
          ...
          null != h.getDerivedStateFromProps &&
            (d._nextState == d.state && (d._nextState = ze({}, d._nextState)),
            ze(d._nextState, h.getDerivedStateFromProps(f, d._nextState))),
          (_ = d.props),
          (m = d.state),
          u)
        )
        ...
        (d.context = y),
          ...
          (d.state = d._nextState),
          null != d.getChildContext && (s = ze(ze({}, s), d.getChildContext())),
          u ||
            null == d.getSnapshotBeforeUpdate ||
            (p = d.getSnapshotBeforeUpdate(_, m));
        var b =
          null != c && c.type === Fe && null == c.key ? c.props.children : c;
        Ze(e, Array.isArray(b) ? b : [b], t, n, s, a, i, r, o, l),
          (d.base = t._dom),
          (t._hydrating = null),
          d._renderCallbacks.length && r.push(d),
        ...
        null == i && t._original === n._original
          ...
          : (t._dom = (function (e, t, n, s, a, i, r, o) {
              var l = n.props,
                c = t.props,
                h = t.type,
                d = 0;
              ...
              if (null === h) l === c || (o && e.data === c) || (e.data = c);
                ...
                i = i && Oe.slice.call(e.childNodes);
                var _ = (l = n.props || He).dangerouslySetInnerHTML,
                ...
                if (
                  ...
                  for (d = i.length; d--; ) null != i[d] && Re(i[d]);
                o ||
                  ("value" in c &&
                    void 0 !== (d = c.value) &&
                    (d !== e.value || ("progress" === h && !d)) &&
                    tt(e, "value", d, l.value, !1),
                  "checked" in c &&
                    void 0 !== (d = c.checked) &&
                    d !== e.checked &&
                    tt(e, "checked", d, l.checked, !1));
              }
              return e;
            })(n._dom, t, n, s, a, i, r, l));
      (c = Ye.diffed) && c(t);
    } catch (e) {
      (t._original = null),
        (l || null != i) &&
          ((t._dom = o), (t._hydrating = !!l), (i[i.indexOf(o)] = null)),
        Ye._catchError(e, t, n);
    }
  }
  function it(e, t) {
    Ye._commit && Ye._commit(t, e),
      e.some(function (t) {
        try {
  ...
  function ot(e, t, n) {
    ...
    if (
      ...
      (s = e.ref) && ((s.current && s.current !== e._dom) || rt(s, null, t)),
      n || "function" == typeof e.type || (n = null != (a = e._dom)),
    ...
    if ((s = e._children))
      for (var i = 0; i < s.length; i++) s[i] && ot(s[i], t, n);
    null != a && Re(a);
  }
  function lt(e, t, n) {
  ...
  function ct(e, t, n) {
    Ye._root && Ye._root(e, t);
    var s = "function" == typeof n,
      a = s ? null : (n && n._children) || t._children,
      i = [];
    at(
      t,
      (e = ((!s && n) || t)._children = Ue(Fe, null, [e])),
      a || He,
      He,
      ...
      !s && n
        ...
        ? null
        : t.firstChild
        ? Oe.slice.call(t.childNodes)
        : null,
      i,
      !s && n ? n : a ? a._dom : t.firstChild,
      s
    ),
      it(i, e);
  }
  ...
  var dt = (function (e) {
    ...
    return (
      ...
      (t.prototype.shouldComponentUpdate = function (e, t) {
        return ut(e, this.props) || ut(t, this.state);
      }),
      t
    );
  })(We);
  ...
  Ye.vnode = function (e) {
    ...
    if (F(e.type)) {
      for (var s in t) {
        ...
        /^onAni/.test(s)
          ? (s = s.toLowerCase())
          : /ondoubleclick/i.test(s) && (s = "ondblclick"),
          (n[s] = a);
      }
      e.props = n;
    }
  ...
  function vt(e, t, n, s, a) {
    Ne(e, t)
      ? e.__mbscFormInst || ft(n, e, a, s, !0)
      : Ie(e.querySelectorAll(t), function (e) {
          e.__mbscFormInst || ft(n, e, a, s, !0);
        });
  }
  function ft(e, t, n, a, i) {
    var r,
      o,
      l = [],
      c = [],
    ...
    if (g)
      for (var y in g)
        if (g.hasOwnProperty(y)) {
          var b = g[y],
            D = u.querySelector("[mbsc-" + b + "]");
          D &&
            ((h[y] = D),
            D.parentNode.removeChild(D),
            (f[y] = _t("span", { className: "mbsc-slot-" + b })));
        }
    if (
      (d.hasChildren &&
        (Ie(m.childNodes, function (e) {
          e !== t &&
            8 !== e.nodeType &&
            (3 !== e.nodeType ||
    ...
    if ((d.hasValue && (t.value = v), g)) {
      var w = function (e) {
        if (h.hasOwnProperty(e)) {
          var t = g[e],
            n = h[e];
          Ie(u.querySelectorAll(".mbsc-slot-" + t), function (e, t) {
    ...
    if (e)
      for (var n in mt)
        if (mt.hasOwnProperty(n)) {
          var s = mt[n];
          vt(e, s._selector, s, s._renderOpt, t);
        }
  }
  function bt(e, t) {
    return function (n, s) {
      ...
      (s =
        e > 1582 || (1582 === e && t > 10) || (1582 === e && 10 === t && n > 14)
          ...
          : 367 * e -
            ...
            n +
            1729777),
      (r = Dt(((a = s - 1948440 + 10632) - 1) / 10631)),
      (i =
        Dt((10985 - (a = a - 10631 * r + 354)) / 5316) * Dt((50 * a) / 17719) +
        Dt(a / 5670) * Dt((43 * a) / 15238)),
      (a =
        a -
  ...
  u &&
    (ee.addEventListener("DOMContentLoaded", function () {
      yt(ee);
    }),
    ee.addEventListener("mbsc-enhance", function (e) {
      yt(e.target);
    }));
  var kt = {
      getYear: function (e) {
      ...
      getDate: function (e, t, n, s, a, i, r) {
        ...
        var o = (function (e, t, n) {
          ...
          return (
            c > 2299160
              ? ((i = Dt((4 * (s = c + 68569)) / 146097)),
                (s -= Dt((146097 * i + 3) / 4)),
                (r = Dt((4e3 * (s + 1)) / 1461001)),
                (s = s - Dt((1461 * r) / 4) + 31),
                (a = Dt((80 * s) / 2447)),
                (n = s - Dt((2447 * a) / 80)),
                (t = a + 2 - 12 * (s = Dt(a / 11))),
                (e = 100 * (i - 49) + r + s))
              : ((o = Dt(((a = c + 1402) - 1) / 1461)),
                (i = Dt(((s = a - 1461 * o) - 1) / 365) - Dt(s / 1461)),
                (a = Dt((80 * (r = s - 365 * i + 30)) / 2447)),
                (n = r - Dt((2447 * a) / 80)),
                (t = a + 2 - 12 * (r = Dt(a / 11))),
                (e = 4 * o + i + r - 4716)),
            (l[2] = n),
    ...
    Tt = [31, 31, 31, 31, 31, 31, 30, 30, 30, 30, 30, 29];
  function xt(e, t, n) {
    var s,
      a = e - 1600,
      i = t - 1,
      r = n - 1,
      o = 365 * a + J((a + 3) / 4) - J((a + 99) / 100) + J((a + 399) / 400);
    for (s = 0; s < i; ++s) o += wt[s];
    i > 1 && ((a % 4 == 0 && a % 100 != 0) || a % 400 == 0) && ++o;
    var l = (o += r) - 79,
      c = 979 + 33 * J(l / 12053) + 4 * J((l %= 12053) / 1461);
    for (
      (l %= 1461) >= 366 && ((c += J((l - 1) / 365)), (l = (l - 1) % 365)),
        s = 0;
      s < 11 && l >= Tt[s];
      ++s
    )
  ...
  var St = {
      getYear: function (e) {
        return xt(e.getFullYear(), e.getMonth() + 1, e.getDate())[0];
      },
      getMonth: function (e) {
        return --xt(e.getFullYear(), e.getMonth() + 1, e.getDate())[1];
      },
      getDay: function (e) {
        return xt(e.getFullYear(), e.getMonth() + 1, e.getDate())[2];
      },
      getDate: function (e, t, n, s, a, i, r) {
        t < 0 && ((e += J(t / 12)), (t = t % 12 ? 12 + (t % 12) : 0)),
          t > 11 && ((e += J(t / 12)), (t %= 12));
        var o = (function (e, t, n) {
          var s,
            a = e - 979,
            i = t - 1,
            r = n - 1,
            o = 365 * a + 8 * J(a / 33) + J(((a % 33) + 3) / 4);
          for (s = 0; s < i; ++s) o += Tt[s];
          var l = (o += r) + 79,
            c = 1600 + 400 * J(l / 146097),
            h = !0;
          for (
            (l %= 146097) >= 36525 &&
              ((c += 100 * J(--l / 36524)),
              (l %= 36524) >= 365 ? l++ : (h = !1)),
              c += 4 * J(l / 1461),
              (l %= 1461) >= 366 && ((h = !1), (c += J(--l / 365)), (l %= 365)),
              s = 0;
            l >= wt[s] + (1 === s && h ? 1 : 0);
            s++
          )
      ...
      getMaxDayOfMonth: function (e, t) {
        ...
        for (
          ...
          !(
            ...
            s > 12 ||
            a < 1 ||
            a > Tt[s - 1] + (12 === s && ((n - 979) % 33) % 4 == 0 ? 1 : 0)
          ));
  ...
  function Ut(e, t, n) {
    ...
    if (n)
      for (s in i)
        i.hasOwnProperty(s) && (a = e[i[s] - t]) && (n[s] = "tz" === s ? a : 1);
  }
  function At(e) {
    return (
      +new Date(
  ...
  function Bt(e, t, n, s, a) {
    return ((!t && !a) || e.exclusiveEndDates) && n && s && n < s
      ? tn(t ? H : e, +s - 1)
      : s;
  }
  function Xt(e) {
    ...
    for (a = 0; a < e.length; a++)
      if (o) "'" !== e.charAt(a) || h("'") ? (r += e.charAt(a)) : (o = !1);
        ...
        switch (e.charAt(a)) {
          ...
          case "Y":
            (i = l.getYear(t)),
              (r += 3 === h("Y") ? i : (i % 100 < 10 ? "0" : "") + (i % 100));
            break;
          case "h":
            var _ = t.getHours();
            r += d("h", _ > 12 ? _ - 12 : 0 === _ ? 12 : _, 2);
            break;
          case "H":
            r += d("H", t.getHours(), 2);
            break;
  ...
  function an(e, t, n) {
    ...
    var r,
      ...
      v = 0,
      f = function (t) {
        for (var n = 0, s = r; s + 1 < e.length && e.charAt(s + 1) === t; )
          n++, s++;
        return n;
      },
      g = function (e) {
      ...
      y = function (e) {
        var n = g(e),
          ...
          a = t.substr(v).match(s);
        return a ? ((v += a[0].length), parseInt(a[0], 10)) : 0;
      },
      b = function (e, n, s) {
        for (var a = 3 === g(e) ? s : n, i = 0; i < a.length; i++)
          if (t.substr(v, a[i].length).toLowerCase() === a[i].toLowerCase())
            return (v += a[i].length), i + 1;
        return 0;
      },
      D = function () {
        v++;
      ...
      if (p) "'" !== e.charAt(r) || g("'") ? D() : (p = !1);
        ...
        switch (e.charAt(r)) {
          ...
          case "s":
            ...
            break;
          case "a":
            m = b("a", [a.amText, a.pmText], [a.amText, a.pmText]) - 1;
            break;
          case "A":
            m = b("A", [a.amText, a.pmText], [a.amText, a.pmText]) - 1;
            break;
    ...
    if (l < 100) {
      var C = void 0;
      (C =
        l <= (F(o) ? (new Date().getFullYear() % 100) + parseInt(o, 10) : +o)
          ? 0
          : -100),
        (l += new Date().getFullYear() - (new Date().getFullYear() % 100) + C);
    }
    d = -1 === m ? d : m && d < 12 ? d + 12 : m || 12 !== d ? d : 0;
    var k = a.getDate(l, c - 1, h, d, u, _);
    return a.getYear(k) !== l || a.getMonth(k) + 1 !== c || a.getDay(k) !== h
      ? i
      : k;
  }
  function rn(e) {
    return Ot(e) ? e.clone() : new Date(e);
  }
  function on(e, t) {
    var n = rn(e);
  ...
  function cn(e, t) {
    var n = Nt * t,
      s = rn(e).setHours(0, 0, 0, 0),
      a = s + Math.round((+e - +s) / n) * n;
    return Ot(e) ? e.createDate(a) : new Date(a);
  }
  u &&
    "undefined" == typeof Symbol &&
    (window.Symbol = { toPrimitive: "toPrimitive" }),
    (b.datetime = { formatDate: sn, parseDate: an });
  var hn = u ? window : H,
    dn = u && !!hn.Promise;
  function un(e, t) {
    if ((e && e(t), dn))
  ...
  var mn,
    pn,
    vn,
    fn = ["https://www.googleapis.com/discovery/v1/apis/calendar/v3/rest"];
  function gn(e, t) {
    var n = mn.timezone,
      s = mn.timezonePlugin,
      a = e.start.date,
      i = e.end.date,
      r = !!a,
      o = a || new Date(e.start.dateTime),
      l = i || new Date(e.end.dateTime);
    if (n && s && !r) {
      var c = { displayTimezone: n, timezonePlugin: s };
      (o = nn(e.start.dateTime, c).toISOString()),
        (l = nn(e.end.dateTime, c).toISOString());
    }
    return {
      allDay: r,
      end: l,
    ...
    kn = {
      init: function (e) {
        u &&
          ((mn = e).gapi
            ? (pn = mn.gapi)
            : _n("https://apis.google.com/js/api.js", function () {
                var t = vn ? "client" : "client:auth2";
                (vn = !e.clientId),
                  (pn = hn.gapi).load(t, function () {
                    pn.client
                      .init({
                        apiKey: mn.apiKey,
                        clientId: vn ? H : mn.clientId,
                        discoveryDocs: fn,
                        scope: vn
                          ? H
                          : mn.scopes ||
                      ...
                      .then(function () {
                        kn.isSignedIn() && e.onSignedIn && e.onSignedIn(),
                          e.onInit && e.onInit();
                      });
                  });
              }));
      ...
      signIn: function () {
        var e = pn.auth2.getAuthInstance();
        return e
          ? e.signIn().then(function () {
              mn && mn.onSignedIn && mn.onSignedIn();
            })
          : H;
      },
      signOut: function () {
        ...
        return e
          ? e.signOut().then(function () {
              mn && mn.onSignedOut && mn.onSignedOut();
            })
          : H;
      },
      isSignedIn: function () {
        var e = pn && pn.auth2 && pn.auth2.getAuthInstance();
        return !(!e || !e.isSignedIn.get());
      },
      getCalendars: function (e) {
        return pn.client.calendar.calendarList.list().then(function (t) {
          return un(e, t.result.items);
        });
      },
      getEvents: function (e, t, n, a) {
        if ((Y(e) || (e = [e]), !e.length || !pn || !pn.client))
          return un(a, []);
        for (var i = pn.client.newBatch(), r = 0, o = e; r < o.length; r++) {
          var l = o[r];
          i.add(
            pn.client.calendar.events.list({
              calendarId: l,
              singleEvents: !0,
              timeMax: n.toISOString(),
              timeMin: t.toISOString(),
            })
          );
        }
        return (
          i.add(pn.client.calendar.colors.get()),
          vn || i.add(pn.client.calendar.calendarList.list()),
          i.then(function (e) {
            var t = e.result,
            ...
            for (var l = 0, c = n; l < c.length; l++) {
              var h = c[l];
              if ("calendar#colors" === h.kind) r = h.event;
              else if ("calendar#calendarList" === h.kind) o = h.items;
              else if ("calendar#events" === h.kind)
                for (
                  var d = function (e) {
                      var t = e.organizer.email,
                        n = o.find(function (e) {
                          return e.id === t;
                        }),
                        a = e.extendedProperties
                          ? e.extendedProperties.shared
                          : H;
                      i.push(
                        s({}, a, gn(e, t), {
                          color: e.colorId
                            ? r[e.colorId].background
                            : vn || !n
                            ? ""
                            : n.backgroundColor,
                          editable:
      ...
      addEvent: function (e, t, n) {
        t.end, t.id, t.start, t.title;
        var s = a(t, ["end", "id", "start", "title"]),
          i = {
            allDay: t.allDay,
            end: {
              date: t.allDay ? Xt(nn(t.end)) : H,
              dateTime: t.allDay ? H : t.end,
            },
            extendedProperties: { shared: s },
            googleCalendarId: e,
            start: {
              date: t.allDay ? Xt(nn(t.start)) : H,
              dateTime: t.allDay ? H : t.start,
            },
            summary: t.title,
          };
        return pn.client.calendar.events
          .insert({ calendarId: e, resource: i })
          .then(function (t) {
            return un(n, gn(t.result, e));
          });
      },
      updateEvent: function (e, t, n) {
        t.end, t.id, t.start, t.title;
        var s = a(t, ["end", "id", "start", "title"]),
          i = {
            allDay: t.allDay,
        ...
        return pn.client.calendar.events
          .update({ calendarId: e, eventId: t.id, resource: i })
          .then(function (t) {
            return un(n, gn(t.result, e));
          });
      },
      deleteEvent: function (e, t, n) {
        return pn.client.calendar.events
          .delete({ calendarId: e, eventId: t.id })
          .then(function () {
            return un(n, t);
          });
      },
  ...
  function xn() {
    return new bn.PublicClientApplication({
      auth: {
        clientId: yn.clientId,
        redirectUri: yn.redirectUri || "http://localhost:3000",
      },
    });
  }
  function Sn(e, t) {
    var n =
      new hn.MSGraphAuthCodeMSALBrowserAuthProvider.AuthCodeMSALBrowserAuthenticationProvider(
        Dn,
        { account: e, interactionType: bn.InteractionType.PopUp, scopes: t }
      );
    Cn = hn.MicrosoftGraph.Client.initWithMiddleware({ authProvider: n });
  }
  function En(e, t) {
    var n = yn.timezone,
      s = yn.timezonePlugin,
      a = e.isAllDay,
      i = a ? e.start.dateTime.split(".")[0] : new Date(e.start.dateTime + "Z"),
      r = a ? e.end.dateTime.split(".")[0] : new Date(e.end.dateTime + "Z");
    if (n && s && !a) {
      var o = { displayTimezone: n, timezonePlugin: s };
      (i = nn(e.start.dateTime, o).toISOString()),
        (r = nn(e.end.dateTime, o).toISOString());
    }
    return {
      allDay: a,
      end: r,
    ...
    Ln = {
      init: function (e) {
        u &&
          ((yn = e),
          e.msal && e.msalClient
            ? ((bn = e.msal), (Dn = e.msalClient || xn()))
            : _n(
                "https://cdn.jsdelivr.net/npm/@microsoft/microsoft-graph-client@3.0.0/lib/graph-js-sdk.js",
                function () {
                  _n(
                    "https://alcdn.msauth.net/browser/2.16.1/js/msal-browser.min.js",
                    function () {
                      (bn = hn.msal),
                        _n(
                          ...
                          function () {
                            (Dn = xn()),
                              Ln.isSignedIn() &&
                                (Sn(Dn.getActiveAccount(), wn.scopes),
                                e.onSignedIn && e.onSignedIn()),
                              e.onInit && e.onInit();
                          }
                        );
                    }
      ...
      signIn: function () {
        return Dn.loginPopup(wn).then(function (e) {
          Dn.setActiveAccount(e.account),
            Sn(e.account, wn.scopes),
            yn.onSignedIn && yn.onSignedIn();
        });
      },
      signOut: function () {
        return Dn.logoutPopup(wn).then(function (e) {
          yn.onSignedOut && yn.onSignedOut();
        });
      },
      isSignedIn: function () {
        return !(!Dn || !Dn.getActiveAccount());
      },
      getCalendars: function (e) {
        return Cn.api("/me/calendars")
          .get()
          .then(function (t) {
            return un(e, t.value);
          });
      ...
      getEvents: function (e, t, n, a) {
        if ((Y(e) || (e = [e]), !e.length)) return un(a, []);
        var i = hn.MicrosoftGraph,
          r = [],
          o = [],
          l = [],
          c = [];
        return (
          ...
          e.forEach(function (s, a) {
            r.push(
              {
                dependsOn: 0 === a ? ["colors"] : ["events_" + e[a - 1]],
                id: "calendars_" + a,
                request: new Request("/me/calendars/" + s, { method: "GET" }),
              },
              {
                dependsOn: ["calendars_" + a],
                id: "events_" + e[a],
                request: new Request(
                  "/me/calendars/" +
                    s +
          ...
          new i.BatchRequestContent(r)
            .getContent()
            .then(function (e) {
              return Cn.api("/$batch").post(e);
            })
            .then(function (e) {
              for (
                var t = function (e) {
                    var t = e.id,
                      n = e.body;
                    if ("colors" === t) c = n.value;
                    else if (t.includes("calendars"))
                      o.push({
                        canEdit: n.canEdit,
                        hexColor: n.hexColor,
                        id: n.id,
                      ...
                      for (
                        var a = t.replace("events_", ""),
                          ...
                          r = function (e) {
                            var t = e.categories
                              ? c.find(function (t) {
                                  return t.displayName === e.categories[0];
                                })
                              : H;
                            l.push(
                              s({}, En(e, a), {
                                color: t ? Tn[t.color] : i.hexColor,
                                editable: i.canEdit,
                                outlookEvent: e,
                              })
                            );
      ...
      addEvent: function (e, t, n) {
        var s = t.allDay,
          a = s ? Xt(nn(t.start)) : t.start,
          i = {
            end: {
              dateTime: s ? Xt(nn(t.end)) : t.end,
              timeZone: yn.timezone || "UTC",
            },
            isAllDay: s,
            start: { dateTime: a, timeZone: yn.timezone || "UTC" },
            subject: t.title,
          };
        return Cn.api("/me/calendars/" + e + "/events")
          .post(i)
          .then(function (t) {
            return un(n, En(t, e));
          });
      ...
      updateEvent: function (e, t, n) {
        var s = t.allDay,
          a = s && t.start ? Xt(nn(t.start)) : t.start,
          i = s && t.end ? Xt(nn(t.end)) : t.end,
          r = {
            end: i ? { dateTime: i, timezone: yn.timezone || "UTC" } : H,
            isAllDay: t.allDay,
            start: a ? { dateTime: a, timezone: yn.timezone || "UTC" } : H,
            subject: t.title,
          };
        return Cn.api("/me/calendars/" + e + "/events/" + t.id)
          .update(r)
          .then(function (t) {
            return un(n, En(t, e));
          });
    ...
    Nn = (function (e) {
      ...
      return (
        ...
        (t.prototype._enhance = function () {
          ...
          e && (yt(!0 === e ? this._el : e), (this._shouldEnhance = !1));
        }),
        t
      );
    })(dt),
    In = 0,
    Hn = { large: 992, medium: 768, small: 576, xlarge: 1200, xsmall: 0 };
  _ &&
    ((Mn = _.matches),
  ...
  var On,
    ...
    zn = (function (e) {
      ...
      return (
        ...
        (t.prototype.__destroy = function () {
          this._optChange !== H && k.unsubscribe(this._optChange),
        ...
        (t.prototype._resp = function (e) {
          var t,
            ...
            s = -1,
            a = this.state.width;
          if ((a === H && (a = te ? te.innerWidth : 375), n && a))
            for (var i in n)
        ...
        (t.prototype._merge = function () {
          var e,
            ...
            o = this._opt || {},
            l = {};
          if (((this._prevS = this.s || {}), r)) {
            for (var c in this.props)
              this.props[c] !== H && (l[c] = this.props[c]);
            var h = l.locale || o.locale || y.locale || {},
              u =
                ...
                o.calendarSystem ||
                y.calendarSystem,
              _ = l.theme || o.theme || y.theme,
              m = l.themeVariant || o.themeVariant || y.themeVariant;
            ("auto" !== _ && _) || (_ = C.theme),
              ("dark" !== m && (!Mn || ("auto" !== m && m))) ||
                !D[_ + "-dark"] ||
                (_ += "-dark"),
              (l.theme = _);
            var p = (n = D[_]) && D[_][a._name];
            t = s({}, r, p, h, y, o, u, l);
            var v = this._resp(t);
          ...
          (e = n && n.baseTheme),
            ...
            (this._touchUi =
              "auto" === t.touchUi || t.touchUi === H ? d : t.touchUi),
            (this._hb =
              "ios" !== i || ("ios" !== t.theme && "ios" !== e)
                ? ""
                : " mbsc-hb");
        }),
        (t.defaults = H),
          ...
          (this._hasChildren = !F(e.name)),
            (this._cssClass =
              ...
              (e.name && !this._hasChildren
                ...
                : "")),
            (this._svg = e.svg ? this._safeHtml(e.svg) : H);
        }),
        t
      );
    })(zn),
  ...
  function ls(e) {
    !is ||
      On ||
      e.isMbscTap ||
      ("TEXTAREA" === e.target.nodeName && e.type === qn) ||
      (e.stopPropagation(), e.preventDefault());
  }
  function cs(e) {
    we(e.target).__mbscFocusVisible = !1;
  }
  function hs(e) {
    we(e.target).__mbscFocusVisible = !0;
  }
  function ds(e) {
    be(e.target).__mbscMoveObs.next(e);
  }
  function us(e) {
    e &&
      setTimeout(function () {
  ...
  function _s(e, t) {
    ...
    function C(e) {
      if (e.type === es) Pn = !0;
      else if (Pn) return e.type === qn && (Pn = !1), !0;
      return !1;
    }
    function k() {
      l &&
    ...
    function T(e) {
      if (!C(e) && (e.type !== qn || (0 === e.button && !e.ctrlKey))) {
        if (
          ((u = rs(e, "X")),
          (_ = rs(e, "Y")),
          (m = u),
    ...
    function x(e) {
      g &&
        ...
        (v = m - u),
        (f = p - _),
        !h && (Math.abs(v) > 9 || Math.abs(f) > 9) && ((h = !0), w(i)),
        (y.moved = h),
        (y.endX = m),
        (y.endY = p),
        (y.deltaX = v),
    ...
    function S(e) {
      g &&
        ...
        w(i, 75),
        (g = !1),
        e.type === ns && t.click && me && !h && os(e, e.target),
        e.type === Kn && (ye(D, Gn, x), ye(D, Kn, S)),
        ye(D, Wn, P));
    }
    function E(e) {
    ...
    function O(e) {
      (y.domEvent = e), Pn || t.onDoubleClick(y);
    }
    function P(e) {
      Pn && e.preventDefault();
    }
    if (
      ...
      var z = D.__mbscMoveCount || 0,
        R = D.__mbscMoveObs || new c();
      0 === z && ge(D, ts, ds, { passive: !1 }),
        (D.__mbscMoveObs = R),
        (D.__mbscMoveCount = ++z),
        (d = R.subscribe(x));
    }
    if (
      (t.onChange && ge(e, An, H),
      t.onHoverIn && ge(e, Jn, E),
      t.onHoverOut && ge(e, Zn, M),
      t.onKeyDown && ge(e, jn, L),
      t.onFocus && b && (ge(e, Bn, N), !t.keepFocus))
    ) {
      var Y = b.__mbscFocusCount || 0;
      0 === Y && (ge(b, qn, cs, !0), ge(b, jn, hs, !0)),
        (b.__mbscFocusCount = ++Y);
    }
    return (
      t.onBlur && ge(e, Un, I),
      t.onDoubleClick && ge(e, Vn, O),
      function () {
        if ((clearTimeout(a), t.onFocus && b && !t.keepFocus)) {
          var n = b.__mbscFocusCount || 0;
          (b.__mbscFocusCount = --n), n <= 0 && (ye(b, qn, cs), ye(b, jn, hs));
        }
        if (D) {
          ...
          (D.__mbscMoveCount = --s),
            ...
            s <= 0 &&
              (delete D.__mbscMoveCount,
              delete D.__mbscMoveObs,
              ye(D, ts, ds, { passive: !1 }));
        }
        ye(e, qn, T, { passive: !0 }),
          ye(e, ns, S),
          ye(e, ss, S),
  ...
  u &&
    (["mousedown", Jn, qn, Kn, Fn].forEach(function (e) {
      ee.addEventListener(e, ls, !0);
    }),
    "android" === i &&
      o < 5 &&
      ee.addEventListener(
      ...
      return (
        ...
        (t.prototype._render = function (e, t) {
          ...
          (this._isIconOnly = !(!e.icon && !e.iconSvg)),
            ...
            (this._tabIndex = s ? H : e.tabIndex || 0),
            (this._cssClass =
              this._className +
      ...
      return (
        ...
        (t.prototype._template = function (e) {
          ...
          return "span" === e.tag
            ...
            : "a" === e.tag
            ? _t("a", s({ "aria-disabled": e.disabled }, _), m)
            : _t("button", s({}, _), m);
        }),
        t
      );
    })(ws),
    xs = { 0: "SU", 1: "MO", 2: "TU", 3: "WE", 4: "TH", 5: "FR", 6: "SA" },
    Ss = { SU: 0, MO: 1, TU: 2, WE: 3, TH: 4, FR: 5, SA: 6 },
    Es = {
      byday: "weekDays",
      bymonth: "month",
      bymonthday: "day",
  ...
  function Ms(e, t, n, s) {
    var a = nn(t.start, t.allDay ? H : n),
      i = nn(t.end, t.allDay ? H : n),
      r = i - a;
    for (
      s && ((t.start = a), (t.end = i)),
        a = jt(a),
        i = n.exclusiveEndDates ? i : jt(on(i, 1));
      a < i || !r;

    )
      Ls(e, a, t), (a = on(a, 1)), (r = 1);
  }
  function Ls(e, t, n) {
    var s = Xt(t);
    (e[s] = e[s] || []), e[s].push(n);
  }
  function Ns(e, t, n, s, a, i) {
    var r = {};
    if (a)
      for (var o = 0, l = Hs(a); o < l.length; o++) {
        r[Xt(nn(l[o]))] = !0;
      }
    if (i)
      for (var c = 0, h = Os(i, e, t, n, s); c < h.length; c++) {
        r[Xt(h[c].d)] = !0;
      }
    return r;
  }
  function Is(e) {
    return F(e) || e.getTime || e.toDate ? e : e.start || e.date;
  }
  function Hs(e) {
    return e ? (Y(e) ? e : F(e) ? e.split(",") : [e]) : [];
  }
  function Os(e, t, n, s, a, i, r, o) {
    F(e) &&
      (e = (function (e) {
    ...
    var l,
      ...
      v = e.interval || 1,
      f = e.count,
      g = e.from ? nn(e.from) : t || (1 !== v || f !== H ? new Date() : n),
      y = e.until ? nn(e.until) : 1 / 0,
      b = g < n,
      D = b ? n : jt(g),
      C = "first" === o,
      k = "last" === o,
      w = C || k || !s || y < s ? y : s,
      T = f === H ? 1 / 0 : f,
      x = (e.weekDays || xs[g.getDay()]).split(","),
      S = Ss[(e.weekStart || "MO").trim().toUpperCase()],
      E = +(e.day || u(g)),
      M = +(e.month || d(g) + 1),
      L = [],
      N = s ? Ns(t, n, s, a, i, r) : {},
    ...
    switch (p) {
      case "daily":
        for (P = f && b ? J(Gt(g, n) / v) : 0; I; )
          (c = _(h(g), d(g), u(g) + P * v)),
            s || (N = Ns(c, c, on(c, 1), a, i, r)),
            c < w && P < T ? (Y(), P++) : (I = !1);
        break;
      case "weekly":
        for (
          ...
          var j = X[B];
          U.push(Ss[j.trim().toUpperCase()]);
        }
        for (
          U.sort(function (e, t) {
            return (
              (e = (e -= V) < 0 ? e + 7 : e) - (t = (t -= V) < 0 ? t + 7 : t)
            );
          });
          I;

        ) {
          for (var q = 0, G = U; q < G.length; q++) {
            (l = on(W, (j = G[q]) < S ? j - S + 7 : j - S)),
              (c = _(h(l), d(l), u(l) + 7 * O * v)),
              s || (N = Ns(c, c, on(c, 1), a, i, r)),
              c < w && P < T ? c >= A && (Y(), P++) : (I = !1);
          }
          O++;
        ...
        if (u.recurring)
          for (
            var p = Yt.test(_) ? null : nn(_),
              ...
              y = tn(u.allDay ? H : c, m),
              b = u.end ? nn(u.end, u.allDay ? H : a) : y,
              D = +b - +y,
              C = 0,
              k = g;
            C < k.length;
            ...
            if (
              ...
              } else x.end = tn(c, +x.start + D);
              "00:00" === u.end && x.end.setHours(23, 59, 59, 999);
            }
            (x.nr = w.i),
              (x.original = u),
              x.start && x.end ? Ms(r, x, a, i) : Ls(r, T, x);
          }
        else u.start && u.end ? Ms(r, u, a, i) : m && Ls(r, m, u);
      }
      return r;
    }
  }
  ...
  function Ys(e, t, n) {
    ...
    function u() {
      ...
      (r = 0),
        c ||
          (e - h > 200 && !s.scrollTop && !s.scrollLeft && ((h = e), d()),
          r || (r = ce(u)));
    }
    function _() {
      o || (o = ce(m));
    ...
    return (
      te && te.ResizeObserver
        ? (zs ||
            (zs = new te.ResizeObserver(function (e) {
              o ||
                (o = ce(function () {
          ...
          : ce(u)),
      {
        detach: function () {
          zs
            ? (Rs--, delete e.__mbscResize, zs.unobserve(e), Rs || (zs = H))
            : (i &&
                (ye(s, "scroll", _),
                ye(l, "scroll", _),
                e.removeChild(i),
  ...
  function Bs(e, t) {
    var n = t.refDate ? nn(t.refDate) : Lt,
  ...
  function js(e, t) {
    var n = t.refDate ? nn(t.refDate) : Lt;
    return J((t.getYear(e) - t.getYear(n)) / 12);
  }
  function qs(e, t) {
    var n = t.refDate ? nn(t.refDate) : Lt;
  ...
  function Ks(e, t, n, s, a, i, r, o, l, c, h, d, u, _) {
    t = t || {};
    for (var m = {}, p = {}, v = n, f = 0, g = a, y = s; v < s; ) {
      var b = Xt(v),
        D = v.getDay(),
        C = e.getDay(v),
        k = h && e.getDate(e.getYear(v), e.getMonth(v) + 1, 0),
        w = (l && (D === o || (1 === C && h))) || +v == +n,
        T = Js(t[b] || [], c),
        x = void 0,
        S = void 0,
      ...
      for (
        d &&
        (I.push({ id: "count_" + +v, count: N, placeholder: 0 === N }),
        (E = g));
        N && E < g;
        ...
        for (var O = 0; O < T.length; O++)
          p[E] === T[O] && ((x = T[O]), (S = O));
        if (E === g - 1 && (M < N - 1 || (L === N && !x)) && -1 !== a) {
          var P = N - M,
            z = u || "",
            R = ((P > 1 && _) || z).replace(/{count}/, P);
          if ((P && I.push({ id: "more_" + ++f, more: R }), x)) {
            p[E] = null;
            for (var Y = 0, U = x._days; Y < U.length; Y++) {
              m[Xt(U[Y])].data[E] = {
                id: "more_" + ++f,
                more: z.replace(/{count}/, "1"),
              };
            }
          }
          M++, E++;
          ...
          S === L && L++,
            Jt(v, nn(x.end, x.allDay ? H : e)) && (p[E] = null),
            I.push({ id: x.id + (x.recurring ? "_" + x.nr : ""), event: x }),
            E++,
            M++,
            x._days.push(v);
        else if (L < N) {
          var A = T[L],
            F = A.allDay,
            W = A.start && nn(A.start, F ? H : e);
          if (!W || Jt(v, W) || w) {
            var V = Bt(e, F, W, A.end && nn(A.end, F ? H : e), !0),
              B = V && !Jt(W, V),
              X = k && k < V ? k : V;
            A.id === H && (A.id = "mbsc_" + Ws++),
              B && (p[E] = A),
              (A._days = [v]),
              I.push({
                event: A,
                id: A.id + (A.recurring ? "_" + A.nr : ""),
                lastDay: k ? on(k, 1) : H,
                multiDay: B,
                showText: !0,
                width: B ? 100 * Math.min(Gt(v, X) + 1, Gt(v, y)) : 100,
              }),
              E++,
              M++;
          }
          L++;
        } else M < N && I.push({ id: "ph_" + ++f, placeholder: !0 }), E++;
      }
      (m[b] = { data: I, events: T }), (v = jt(on(v, 1)));
    }
    return m;
  }
  function Js(e, t) {
  ...
  var Zs,
    ...
    Qs = (function (e) {
      function t() {
        ...
        return (
          ...
          (t._onMonthClick = function (e) {
            var n = e.date,
              s = t.s;
            if (s.selectView === As) t._hook("onDayClick", e);
            else {
              var a = Xs(n, s) - t._offset;
              t._changeView(Us),
                (t._shouldFocus = !0),
          ...
          (t._onYearClick = function (e) {
            var n = t.s,
              s = n.selectView,
              a = "year" === (n.showCalendar ? n.calendarType : n.eventRange);
            (s === Fs || a) && t._hook("onDayClick", e),
              s !== Fs &&
                ((t._shouldFocus = !0),
                (t._prevAnim = s === As),
          ...
          (t._onViewAnimationEnd = function () {
            t.state.viewOpening === H
              ? t.setState({ viewClosing: H })
              : t.setState({ viewOpening: H });
          }),
          ...
          (t._onKeyDown = function (e) {
            var n,
              s = t.s,
              a = t._view,
              i = a === Us ? t._active : t._activeMonth,
              r = new Date(i),
              o = s.getYear(r),
              l = s.getMonth(r),
              c = s.getDay(r),
      ...
      return (
        ...
        (t.prototype._getPageDay = function (e) {
          return +Bs(e + this._offset, this.s);
        }),
        (t.prototype._getPageStyle = function (e, t, n) {
          var s;
          return (
            ((s = {})[(pe ? pe + "T" : "t") + "ransform"] =
              "translate" +
              this._axis +
              "(" +
              100 * (e - t) * this._rtlNr +
          ...
          switch (e) {
            ...
            case Fs:
              t =
                a && r === Us
                  ? ""
                  : (o === Fs ? "in-up" : "") + (r === Fs ? "out-up" : "");
              break;
            default:
              t =
                a && o === Us
                  ? ""
                  : (o === As ? (r === Fs ? "in-down" : "in-up") : "") +
                    (r === As ? (o === Fs ? "out-down" : "out-up") : "");
          }
          return s + n + (de && t ? " " + s + "-" + t : "");
        }),
        (t.prototype._isNextDisabled = function (e) {
          if (!this._hasPicker || e) {
            var t = this._view;
            if (t === Fs) return this._yearsIndex + 1 > this._maxYearsIndex;
        ...
        (t.prototype._isPrevDisabled = function (e) {
          if (!this._hasPicker || e) {
            var t = this._view;
            if (t === Fs) return this._yearsIndex - 1 < this._minYearsIndex;
        ...
        (t.prototype._render = function (e, t) {
          ...
          (m === this._weeks && this._pageIndex !== H) || (this._offset = T),
            v && (this._activeMonth = p);
          var x = js(new Date(this._activeMonth), e),
            S = qs(new Date(this._activeMonth), e);
          if (
            (v && ((this._yearsOffset = x), (this._yearOffset = S)),
            (this._view = t.view || e.selectView),
            (this._yearsIndex = x - this._yearsOffset),
            (this._yearIndex = S - this._yearOffset),
            this._view === As)
          )
            this._viewTitle = this._getPageYear(this._yearIndex) + "";
          else if (this._view === Fs) {
          ...
          var M,
            ...
            N =
              ...
              (L = t.pageSize),
              "auto" === M
                ? Math.max(1, Math.min(3, Math.floor(L ? L / 296 : 1)))
                : M
                ? +M
                : 1),
            I =
          ...
          i ||
            ...
            e.startDay === H ||
            e.endDay === H ||
            ((P = on(P, e.startDay - c + (e.startDay < c ? 7 : 0))),
            (z = on(
              P,
              7 * l +
                e.endDay -
          ...
          var Y = i && O ? Kt(P, e) : P,
            A = Bs(T + N - 1, e),
            F = i && O ? on(Kt(A, e), 7 * m) : z,
            V = i ? Kt(Bs(T - 0 - 1, e), e) : P,
            B = i ? Kt(Bs(T - 0 + N + 1 - 1, e), e) : z,
            X = i ? on(B, 7 * m) : z,
            q = y.search(/m/i),
            G = y.search(/y/i);
          if (W(e.min))
            ...
            if (g.min !== e.min || e.getDate !== g.getDate) {
              var K = nn(e.min);
              (this._minDate = jt(K)),
                (this._minYear = n(s(K), a(K), 1)),
                (this._minYears = s(K));
            }
            (this._minIndex = Xs(this._minDate, e) - this._offset),
              (this._minYearIndex = qs(this._minDate, e) - this._yearOffset),
              (this._minYearsIndex = js(this._minDate, e) - this._yearsOffset);
          }
          if (W(e.max))
            (this._maxDate = 1 / 0),
              (this._maxIndex = 1 / 0),
            ...
            if (g.max !== e.max || e.getDate !== g.getDate) {
              var Z = nn(e.max);
              (this._maxDate = Z),
                (this._maxYear = n(s(Z), a(Z) + 1, 1)),
                (this._maxYears = s(this._maxDate));
            }
            (this._maxIndex = Xs(this._maxDate, e) - this._offset),
              (this._maxYearIndex = qs(this._maxDate, e) - this._yearOffset),
              (this._maxYearsIndex = js(this._maxDate, e) - this._yearsOffset);
          }
          if (_ && ((this._monthsMulti = []), T !== H)) {
            for (var $ = J(t.pageSize / 296) || 1; u % $; ) $--;
            for (var Q = 0; Q < u / $; ++Q) {
              for (var ee = [], te = 0; te < $; ++te)
                ee.push(+n(s(P), a(P) + Q * $ + te, 1));
          ...
          (r !== g.calendarType ||
            ...
            (g.width === e.width && g.height === e.height) ||
              (this._dim = { height: j(e.height), width: j(e.width) }),
            (this._cssClass =
              ...
              e.cssClass),
            (this._dayNames =
              "sm" === t.width || _ ? e.dayNamesMin : e.dayNamesShort),
            (this._isSwipeChange = !1),
            (this._firstDay = P),
            (this._firstPageDay = Y),
            (this._lastDay = z),
            (this._lastPageDay = F),
            (this._yearFirst = G < q),
            (this._pageNr = N),
          ...
          var ne = e.pageLoad !== g.pageLoad,
            se = +V != +this._viewStart || +X != +this._viewEnd;
          if (
            (this._pageIndex !== H &&
              se &&
              ((this._isIndexChange = !this._isSwipeChange && !w),
            ...
            T !== H && (this._pageIndex = T - this._offset),
            T !== H &&
              (e.marked !== g.marked ||
                e.colors !== g.colors ||
                e.labels !== g.labels ||
            ...
            (se || ne) &&
              ...
              (this._viewStart = V),
              (this._viewEnd = X);
            var ae = this._labelsMap || Ps(e.labels, V, X, e),
              ie =
                ae &&
                Ks(
                  e,
            ...
            ie && !this._labels && (this._shouldCheckSize = !0),
              ((ie && t.maxLabels) || !ie) &&
                (this._shouldPageLoad =
                  !this._isIndexChange || this._prevAnim || !i || ne),
              (this._labelsLayout = ie),
              (this._labels = ae),
              (this._marked = !ae && (this._marksMap || Ps(e.marked, V, X, e))),
              (this._colors = Ps(e.colors, V, X, e)),
              (this._valid = Ps(e.valid, V, X, e, !0)),
              (this._invalid = Ps(e.invalid, V, X, e, !0));
          }
          if (
            se ||
            v ||
            ...
            if (h)
              for (
                var le = 0, ce = Object.keys(e.selectedDates);
                le < ce.length;
                le++
              ) {
                var he = ce[le];
            ...
            if (this._pageNr > 1)
              for (Q = 0; Q < N; Q++) {
                var de = n(s(P), a(P) + Q, 1),
                  ue = s(de) + D,
                  _e = b[a(de)];
                this._title.push({ yearTitle: ue, monthTitle: _e });
              }
            else {
              var me = { yearTitle: s(oe) + D, monthTitle: b[a(oe)] },
                pe = e.showSchedule && 1 === l ? "month" : i ? r : o,
                ve = o && !i && (!e.showSchedule || l > 1);
              switch (pe) {
                case "year":
                  (me.title = s(P) + D),
                    l > 1 && (me.title += " - " + (s(re) + D));
                ...
                case "month":
                  if (l > 1 && !i) {
                    ...
                    me.title = ye + " - " + Ce;
                  } else _ && (me.title = s(P) + D);
                  break;
                case "day":
                case "week":
                  if (ve) {
                    var ke = y.search(/d/i) < q ? "D MMM, YYYY" : "MMM D, YYYY";
                    (me.title = sn(ke, P, e)),
                      ("week" === pe || l > 1) &&
                        (me.title += " - " + sn(ke, re, e));
                  }
          ...
          (this._active = p),
            ...
            (this._prevIcon = I
              ...
              ? e.nextIconH
              : e.prevIconH),
            (this._mousewheel = e.mousewheel === H ? I : e.mousewheel),
            (this._isGrid = _),
            (this._isVertical = I),
            (this._showOuter = O);
        }),
        (t.prototype._mounted = function () {
          (this._observer = Ys(this._el, this._onResize, this._zone)),
            (this._doc = be(this._el)),
            ge(this._doc, Fn, this._onDocClick);
        }),
        (t.prototype._updated = function () {
          var e = this;
          if (
        ...
        (t.prototype._pageLoaded = function () {
          this._hook("onPageLoaded", {
            ...
            month: "month" === this.s.calendarType ? this._firstDay : H,
    ...
    ea =
          ...
          if (!this.getChildContext) {
            ...
            (n[Zs] = this),
              ...
              (this.shouldComponentUpdate = function (e) {
                this.props.value !== e.value && t.some(Ke);
              }),
              (this.sub = function (e) {
                t.push(e);
      ...
      ($s.Provider._contextRef = $s.Consumer.contextType = $s)),
    ta = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      }
      return (
        ...
        (t.prototype.render = function () {
          ...
          return (
            ...
            _t(ea.Consumer, null, function (e) {
              var t = e.instance || r || (n && n._calendarView);
              return t && _t(i, s({ inst: t }, o));
            })
          );
        }),
        t
    ...
    ia = function (e) {
      ...
      return _t(
        ...
        t._title.map(function (e, n) {
          return (
            (1 === t._pageNr || 0 === n || t._hasPicker || i === Us) &&
            _t(
              Ts,
              {
              ...
              (t._hasPicker || i === Us) &&
                (e.title
                  ? _t(
                      "span",
                      { className: "mbsc-calendar-title" + a },
                      e.title
                    )
                  : _t(
                      Fe,
                      ...
                      t._yearFirst &&
                        _t(
                          ...
                          {
                            className:
                              "mbsc-calendar-title mbsc-calendar-year" + a,
                          },
                          e.yearTitle
                        ),
                      _t(
                        ...
                        {
                          className:
                            "mbsc-calendar-title mbsc-calendar-month" + a,
                        },
                        e.monthTitle
                      ),
                      !t._yearFirst &&
    ...
    ra = function (e) {
      var t = e.calendar,
        n = e.view,
        i = a(e, ["calendar", "view"]);
      return _t(ta, s({ component: na, host: t, view: n }, i));
    };
  ra._name = "CalendarPrev";
  var oa = function (e) {
    var t = e.calendar,
      n = e.view,
      i = a(e, ["calendar", "view"]);
    return _t(ta, s({ component: sa, host: t, view: n }, i));
  };
  oa._name = "CalendarNext";
  var la = function (e) {
    var t = e.calendar,
      n = e.view,
      i = a(e, ["calendar", "view"]);
    return _t(ta, s({ component: aa, host: t, view: n }, i));
  };
  la._name = "CalendarToday";
  var ca = function (e) {
    var t = e.calendar,
      n = e.view,
      i = a(e, ["calendar", "view"]);
    return _t(ta, s({ component: ia, host: t, view: n }, i));
  };
  function ha(e) {
    return (
      (this.getChildContext = function () {
  ...
  function da(e) {
    ...
    (t.componentWillUnmount = function () {
      ct(null, t._temp), (t._temp = null), (t._container = null);
    }),
      ...
      e._vnode
        ? (t._temp ||
          ...
          ct(Ue(ha, { context: t.context }, e._vnode), t._temp))
        : t._temp && t.componentWillUnmount();
  }
  function ua(e, t) {
    return Ue(da, { _vnode: e, _container: t });
  }
  ca._name = "CalendarNav";
  var _a,
    ma = (function (e) {
      function t() {
        return (null !== e && e.apply(this, arguments)) || this;
      ...
      return (
        ...
        (t.prototype.render = function () {
          ...
          return e ? ua(this.props.children, e) : null;
        }),
        t
      );
    })(We),
    pa = "input,select,textarea,button",
    va = 'textarea,button,input[type="button"],input[type="submit"]',
    fa = pa + ',[tabindex="0"]',
    ga = { enter: ms, esc: 27, space: ps },
    ya = u && /(iphone|ipod)/i.test(m) && o >= 7 && o < 15;
  var ba = (function (e) {
      function t() {
        var t = (null !== e && e.apply(this, arguments)) || this;
        return (
          ...
          (t._onKeyDown = function (e) {
            var n = t.s,
              s = e.keyCode,
              a = n.focusElm && !n.focusOnOpen ? n.focusElm : H;
            if (
              (((s === ps && !Ne(e.target, pa)) ||
                (t._lock && (s === Ds || s === ks))) &&
                e.preventDefault(),
              ...
              var i = t._popup.querySelectorAll(fa),
                r = [],
                o = -1,
                l = 0,
                c = -1,
          ...
          (t._onContentScroll = function (e) {
            !t._lock ||
              (e.type === ts && "stylus" === e.touches[0].touchType) ||
              e.preventDefault();
          }),
          ...
          (t._onWndKeyDown = function (e) {
            ...
            if (_a === t) {
              if (
                ...
                s === ms && Ne(e.target, va) && !e.shiftKey)
              )
                return;
              if (t._buttons)
                for (var a = 0, i = t._buttons; a < i.length; a++)
                  for (
                    var r = i[a],
                      o = 0,
                      l = Y(r.keyCode) ? r.keyCode : [r.keyCode];
                    o < l.length;
                    o++
                  ) {
                    var c = l[o];
                    if (!r.disabled && c !== H && (c === s || ga[c] === s))
          ...
          (t._onResize = function () {
            ...
            (t._vpWidth = Math.min(
              ...
              (t._maxHeight =
                t.s.maxHeight !== H || t._vpWidth < 768 || t._vpHeight < 650
      ...
      return (
        ...
        (t.prototype.position = function () {
          if (this._isOpen) {
            var e = this.s,
              ...
              r = e.anchorAlign,
              o = e.rtl,
              l = ke(this._scrollCont),
              c = Ce(this._scrollCont),
              h = this._vpWidth,
              d = this._vpHeight,
              u = this._maxWidth,
              _ = this._maxHeight,
              m = Math.min(s.offsetWidth, u),
              p = Math.min(s.offsetHeight, _),
              v = e.showArrow;
            (this._lock =
              e.scrollLock &&
            ...
            if ("anchored" !== e.display || f)
              ...
              var g = 0,
                y = 0,
                b = R(t.modalLeft || 0, 8, h - m - 8),
                D = t.modalTop || 8,
                C = "bottom",
                k = {},
                w = v ? 16 : 4,
                T = (n.offsetWidth - h) / 2,
                x = (n.offsetHeight - d) / 2;
              if (a) {
              ...
              if (i && this._ctx.contains(i)) {
                ...
                if (
                  ...
                  (D = M + I + w),
                  (k = { left: R(L + N / 2 - b - T, 30, m - 30) + "px" }),
                  D + p + w > d)
                )
                  if (M - p - w > 0) (C = "top"), (D = M - p - w);
                  else if (!e.disableLeftRight) {
                    var H = L - m - 8 > 0;
                    (H || L + N + m + 8 <= h) &&
                      ((D = R(M - (p - I) / 2, 8, d - p - 8)) + p + 8 > d &&
                        (D = Math.max(d - p - 8, 0)),
                      (k = { top: R(M + I / 2 - D - x, 30, p - 30) + "px" }),
                      (C = H ? "left" : "right"),
                      (b = H ? L - m : L + N));
                  }
              }
              ("top" !== C && "bottom" !== C) ||
                (D + p + w > d && ((D = Math.max(d - p - w, 0)), (v = !1))),
                this.setState({
                  arrowPos: k,
                  bubblePos: C,
                  height: d,
        ...
        (t.prototype._render = function (e, t) {
          ...
          var n = e.animation,
            ...
            r = "inline" !== s,
            o = e.fullScreen && r,
            l = !!r && (e.isOpen === H ? t.isOpen : e.isOpen);
          if (
            (l &&
            ...
            (this._style = {
              height: o ? "100%" : j(e.height),
              left: i && t.modalLeft ? t.modalLeft + "px" : "",
              maxHeight: j(this._maxHeight || e.maxHeight),
              maxWidth: j(this._maxWidth || e.maxWidth),
              top: i && t.modalTop ? t.modalTop + "px" : "",
              width: o ? "100%" : j(e.width),
            }),
            (this._hasContext = "body" !== e.context && e.context !== H),
            (this._needsLock =
              ya && !this._hasContext && "anchored" !== s && e.scrollLock),
            (this._isModal = r),
            (this._flexButtons =
              "center" === s ||
              (!this._touchUi && !o && ("top" === s || "bottom" === s))),
            n !== H && !0 !== n)
          )
            this._animation = F(n) ? n : "";
          else
            switch (s) {
              case "bottom":
                ...
                if (t && t.length)
                  return (
                    t.forEach(function (t) {
                      var n = F(t) ? a[t] || { text: t } : t;
                      (n.handler && !F(n.handler)) ||
                        (F(n.handler) && (n.name = n.handler),
        ...
        (t.prototype._updated = function () {
          ...
          if (
            ...
            ((n = F(t.context) ? ee.querySelector(t.context) : t.context) ||
              (n = ee.body),
          ...
          if (this._justOpened) {
            ...
            if (
              ...
              (this._observer = Ys(s, this._onResize, this._zone)),
              ...
              if (!n.__mbscIOSLock) {
                var h = ke(this._scrollCont),
                  d = Ce(this._scrollCont);
                (n.style.left = -d + "px"),
                  (n.style.top = -h + "px"),
            ...
            a && n.classList.add("mbsc-popup-ctx"),
              t.focusTrap && ge(r, Xn, this._onFocus),
              t.focusElm &&
                !t.focusOnOpen &&
                ge(t.focusElm, jn, this._onKeyDown),
              ge(this._scrollCont, ts, this._onContentScroll, { passive: !1 }),
              ge(this._scrollCont, as, this._onContentScroll, { passive: !1 }),
              ge(this._scrollCont, $n, this._onContentScroll, { passive: !1 }),
              setTimeout(function () {
                ge(i, qn, e._onMouseDown),
                  ge(i, Kn, e._onMouseUp),
                  ge(i, Fn, e._onDocClick);
              }),
        ...
        (t.prototype._onOpened = function () {
          ...
          if (e.focusOnOpen) {
            var t = e.activeElm,
              n = t ? (F(t) ? this._popup.querySelector(t) : t) : this._active;
            n && n.focus && n.focus();
          }
          ge(this._win, jn, this._onWndKeyDown),
            ge(this._scrollCont, Qn, this._onScroll);
        }),
        (t.prototype._onClosed = function () {
          ...
          s.mbscModals--,
            ...
            this._hasContext &&
              !s.mbscModals &&
              s.classList.remove("mbsc-popup-ctx"),
            this._hook("onClosed", { focus: a }),
            a && this._prevFocus.focus(),
            setTimeout(function () {
              _a === n && (_a = n._prevModal);
            });
        }),
        (t.prototype._unlisten = function () {
          ye(this._win, jn, this._onWndKeyDown),
            ye(this._scrollCont, Qn, this._onScroll),
            ye(this._scrollCont, ts, this._onContentScroll, { passive: !1 }),
            ye(this._scrollCont, as, this._onContentScroll, { passive: !1 }),
            ye(this._scrollCont, $n, this._onContentScroll, { passive: !1 }),
            ye(this._doc, qn, this._onMouseDown),
            ye(this._doc, Kn, this._onMouseUp),
            ye(this._doc, Fn, this._onDocClick),
            this.s.focusTrap && ye(this._win, Xn, this._onFocus),
            this.s.focusElm && ye(this.s.focusElm, jn, this._onKeyDown),
            this._observer &&
              (this._observer.detach(), (this._observer = null));
        }),
        (t.prototype._close = function (e) {
          this._isOpen &&
            (this.s.isOpen === H && this.setState({ isOpen: !1 }),
  ...
  var wa = (function (e) {
      function t() {
        ...
        return (
          ...
          (t._maxSnapScroll = 0),
          (t._margin = 0),
          (t._scrollEnd = $(function () {
            he(t._raf), (t._raf = !1), t._onEnd(), (t._hasScrolled = !1);
          }, 200)),
          (t._onStart = function (e) {
            ...
            t._hook("onStart", {}),
              (n.changeOnEnd && t._isScrolling) ||
                ...
                (t._velocityX = 0),
                (t._velocityY = 0),
                (t._startPos = Te(t._scrollEl, t._isVertical)),
                (t._timestamp = +new Date()),
                t._isScrolling &&
                  (he(t._raf), (t._raf = !1), t._scroll(t._startPos)));
          }),
          ...
          (t._onEnd = function () {
            if (((t._started = !1), t._hasScrolled)) {
              var e,
                ...
                i = t._delta;
              (i += s * s * 0.5 * (s < 0 ? -1 : 1)),
                a && (i = R(i, -t._round * a, t._round * a));
              var r = R(
                  K((t._startPos + i) / t._round) * t._round,
                  t._min,
                  t._max
                ),
                o = K((-r * t._rtlNr) / n.itemSize) + t._offset,
                l =
                  i > 0
                    ? t._isVertical
                      ? 270
          ...
          (t._onMouseWheel = function (e) {
            ...
            if (t._el.contains(e.target) && n && t.s.mousewheel) {
              if (
                ...
                (n = R(-n, -t._scrollSnap, t._scrollSnap)),
                (t._delta += n),
                t._maxSnapScroll &&
          ...
          (t._onTrackStart = function (e) {
            ...
            if (
              ...
              ge(t._doc, Kn, t._onTrackEnd), ge(t._doc, Gn, t._onTrackMove);
            else {
              var s = Le(t._scrollbarContEl).top,
                a = (n.startY - s) / t._barContSize;
              (t._startPos = t._currPos = t._max + (t._min - t._max) * a),
                (t._hasScrolled = !0),
                t._onEnd();
            }
          }),
          ...
          (t._onTrackEnd = function () {
            (t._delta = 0),
              (t._startPos = t._currPos),
              t._onEnd(),
              ye(t._doc, Kn, t._onTrackEnd),
              ye(t._doc, Gn, t._onTrackMove);
          }),
      ...
      return (
        ...
        (t.prototype._render = function (e, t) {
          ...
          if (((this._scrollSnap = K(44 / g) * g), v)) {
            for (var y = c - s; y < c + i + s; y++)
              h.push({ key: y, data: ka(v, y, m, p) });
            if (e.scroll3d)
              for (y = c - a; y < c + i + a; y++)
                d.push({ key: y, data: ka(v, y, m, p) });
            (this.visibleItems = h),
              (this.visible3dItems = d),
              (this._maxSnapScroll = s),
              (this._isInfinite = "function" == typeof v);
          }
          this._offset === H && (this._offset = o);
          ...
          if (
            ...
            _ && (this._margin += _),
            (this._max =
              m !== H ? -(m - this._offset) * r * this._rtlNr : 1 / 0),
            (this._min =
              p !== H
          ...
          var k = e.visibleSize * r;
          (this._barContSize = k),
            (this._barSize = Math.max(
              20,
              (k * k) / (this._max - this._min + k)
            )),
            (this._cssClass = this._className + " mbsc-ltr");
        }),
        (t.prototype._mounted = function () {
          (this._doc = be(this._el)),
            ge(this._el, Fn, this._onClick, !0),
            ge(this.s.scroll3d ? this._innerEl : this._el, Qn, this._onScroll),
            ge(this._doc, $n, this._onMouseWheel, { passive: !1, capture: !0 }),
            ge(this._doc, as, this._onMouseWheel, { passive: !1, capture: !0 }),
            ge(this._scrollbarContEl, qn, this._onTrackStart),
            ge(this._scrollbarContEl, Fn, this._onTrackClick),
            (this._unlisten = _s(this._el, {
              onEnd: this._onEnd,
              onMove: this._onMove,
        ...
        (t.prototype._updated = function () {
          var e = this.s,
            ...
            s = e.selectedIndex,
            a = this._prevIndex,
            i = !e.prevAnim && ((a !== H && a !== s) || this._isAnimating),
        ...
        (t.prototype._destroy = function () {
          ye(this._el, Fn, this._onClick, !0),
            ye(this.s.scroll3d ? this._innerEl : this._el, Qn, this._onScroll),
            ye(this._doc, $n, this._onMouseWheel, { passive: !1, capture: !0 }),
            ye(this._doc, as, this._onMouseWheel, { passive: !1, capture: !0 }),
            ye(this._scrollbarContEl, qn, this._onTrackStart),
            ye(this._scrollbarContEl, Fn, this._onTrackClick),
            he(this._raf),
            (this._raf = !1),
            this._scroll(0),
            this._unlisten();
        ...
        (t.prototype._anim = function (e) {
          ...
          return (this._raf = ce(function () {
            ...
            if (t._raf) {
              ...
              s - t._lastRaf > 100 &&
                ((t._lastRaf = s),
                (t._currPos = Te(t._scrollEl, t._isVertical)),
        ...
        (t.prototype._infinite = function (e) {
          var t = this.s;
          if (t.itemSize) {
            var n = K((-e * this._rtlNr) / t.itemSize) + this._offset,
              s = n - this._currIndex;
            s &&
              (t.changeOnEnd
        ...
        (t.prototype._scroll = function (e, t) {
          var n = this.s,
            ...
            r = pe ? pe + "T" : "t",
            o = t ? ve + "transform " + K(t) + "ms " + n.easing : "";
          if (
            ((i[r + "ransform"] =
              "translate3d(" + (a ? "0," + e + "px," : e + "px,0,") + "0)"),
            (i[r + "ransition"] = o),
            (this._endPos = e),
            n.scroll3d)
          ) {
            ...
            (l[r + "ransform"] =
              "translateY(-50%) rotateX(" + (-e / s) * c + "deg)"),
              (l[r + "ransition"] = o);
          }
        ...
        (t.prototype._move = function (e, t) {
          ...
          i &&
            !t &&
            (this._delta = R(this._delta, -this._round * i, this._round * i)),
            this._scroll(
              R(
      ...
      return (
          ...
          this._unlisten = _s(this._el, {
            ...
            onDoubleClick: function (e) {
              ...
              t.clickToCreate &&
                ...
                !t.disabled &&
                t.display &&
                (s._hook("onLabelUpdateStart", e),
                s._hook("onLabelUpdateEnd", e)),
                s._cellClick("onDayDoubleClick", e.domEvent);
            },
            onEnd: function (a) {
              e &&
                (a.domEvent.preventDefault(),
                s._hook("onLabelUpdateEnd", a),
                (e = !1)),
                clearTimeout(n),
                (e = !1),
                (t = !1);
              ...
              if (
                ...
                r ||
                  (a.isTouch && i.dragToCreate
                    ? (n = setTimeout(function () {
                        s._hook("onLabelUpdateStart", a),
                          s._hook("onLabelUpdateModeOn", a),
                          (e = !0);
                      }, 350))
        ...
        (t.prototype._render = function (e, t) {
          ...
          (this._draggedLabel = r && r.draggedDates && r.draggedDates[_]),
            ...
            (this._cellStyles =
              f && i ? { backgroundColor: f, color: xe(f) } : H),
            (this._circleStyles = g
              ? { backgroundColor: g, color: xe(v.highlight) }
              : H),
            (this._ariaLabel =
              "day" === e.type
                ? (m ? e.todayText + ", " : "") +
      ...
      function t() {
        ...
        return (
          ...
          (t._onDocTouch = function (e) {
            ye(t._doc, es, t._onDocTouch),
              ye(t._doc, qn, t._onDocTouch),
              (t._isDrag = !1),
      ...
      return (
          ...
          o || ((o = new c()), (Sa[i] = o)),
            ...
            (this._unlisten = _s(this._el, {
              ...
              onEnd: function (n) {
                ...
                clearTimeout(t._touchTimer), (e = H);
              },
              onFocus: function () {
                r || o.next({ hasFocus: !0 });
              },
              onHoverIn: function (e) {
                t._isDrag ||
                  r ||
                  (o.next({ hasHover: !0 }), t._triggerEvent("onHoverIn", e));
              },
              onHoverOut: function (e) {
            ...
            this._isDrag &&
              (ge(this._doc, es, this._onDocTouch),
              ge(this._doc, qn, this._onDocTouch));
        }),
        (t.prototype._destroy = function () {
          if (this._unsubscribe) {
            var e = this.s,
              ...
              s = Sa[n];
            s.unsubscribe(this._unsubscribe), s.nr || delete Sa[n];
          }
          ye(this._doc, es, this._onDocTouch),
            ye(this._doc, qn, this._onDocTouch),
        ...
        (t.prototype._render = function (e, t) {
          ...
          if (
            ...
            (this._html = this._content = H),
            (this._title =
              e.more || e.count || !e.showEventTooltip
                ? H
                : Me(o.tooltip || o.title || o.text)),
            (this._tabIndex =
            ...
            var d = o.allDay,
              u = d ? H : e;
            (n = o.start ? nn(o.start, u) : null),
              (s = o.end ? nn(o.end, u) : null);
            var _ = n && s && Bt(e, d, n, s, !0),
              m = on(Kt(l, e), 7),
              p = e.lastDay && e.lastDay < m ? e.lastDay : m;
            (a = !(h = n && _ && !Jt(n, _)) || (n && Jt(n, l))),
              (i = !h || (_ && Jt(_, l))),
              (r = !h || (e.showText ? _ < p : i)),
              (this._hasResizeStart = e.resize && a),
              (this._hasResizeEnd = e.resize && r);
            var v = o.color;
            if (!v && o.resource && e.resourcesMap) {
              var f =
                e.resourcesMap[Y(o.resource) ? o.resource[0] : o.resource];
              v = f && f.color;
            }
            e.showText && (this._textColor = v ? xe(v) : H),
              (this._color =
                e.render || e.template
                  ? H
                  : o.textColor && !v
          ...
          if (o && e.showText && (c || e.contentTemplate || e.template)) {
            ...
            if (
              ((this._data = {
                end: !g && i && s ? sn(e.timeFormat, s, e) : "",
                id: o.id,
                isMultiDay: h,
                original: o,
                start: !g && a && n ? sn(e.timeFormat, n, e) : "",
                title: this._title,
              }),
              c)
            ) {
              var y = c(this._data);
              F(y)
                ? ((this._html = this._safeHtml(y)), (this._shouldEnhance = !0))
                : (this._content = y);
            }
          } else
        ...
        (t.prototype._template = function (e) {
          ...
          return _t(
            ...
            e.showText && !e.more && e.render
              ? this._html
                ? _t("div", { dangerouslySetInnerHTML: this._html })
                : this._content
              : _t(
                  "div",
                  {
      ...
      return (
        ...
        (t.prototype._template = function (e) {
          ...
          return (
            ...
            F(t) &&
              ((t = _t("div", { dangerouslySetInnerHTML: this._safeHtml(t) })),
            ...
            _t(
              "div",
              {
                ...
                ref: this._setEl,
                className: this._cssClass,
                tabIndex: e.disabled ? H : e.active ? 0 : -1,
                onClick: this._onClick,
                onContextMenu: this._onRightClick,
    ...
    Na = function (e) {
      ...
      return _t(
        ...
        {
          className:
            "mbsc-calendar-week-days mbsc-flex" + (s ? " mbsc-hidden" : ""),
        },
        o &&
          _t("div", {
            className:
        ...
        z.map(function (e, s) {
          return _t(
            ...
            {
              "aria-label": t[(s + n) % 7],
              className: "mbsc-calendar-week-day mbsc-flex-1-0-0" + i + a,
              key: s,
            },
            r[(s + n) % 7]
          );
        }),
        l && _t("div", { className: "mbsc-schedule-fake-scroll-y" })
      );
    };
  function Ia(e, t, n, s, a, i) {
    var r = Xt(t);
  ...
  var Ha = (function (e) {
      ...
      return (
        ...
        (t.prototype._isInvalid = function (e) {
          var t = this.s;
          return Ia(t, en(t, new Date(e)), t.invalid, t.valid, +t.min, +t.max);
        }),
        ...
        (t.prototype._render = function (e) {
          ...
          for (var d = 0; d < 7 * t; d++) {
            var u = e.getDate(a, i, d + n - l - o + r),
              _ = Xt(u),
              m = e.getMonth(u),
              p = m !== i && "week" !== e.calendarType,
              v = e.marked && e.marked[_],
        ...
        (t.prototype._template = function (e, t) {
          ...
          var a = this._variableRow,
            ...
            o = _t(
              ...
              (t.view === Fs || t.viewClosing === Fs || e.selectView === Fs) &&
                _t(
                  "div",
                  {
                    onAnimationEnd: this._onViewAnimationEnd,
                    className: this._getPickerClass(Fs),
                  },
                  _t(
                    Ta,
                    s(
              ...
              (t.view === As || t.viewClosing === As || e.selectView === As) &&
                _t(
                  ...
                  {
                    onAnimationEnd: this._onViewAnimationEnd,
                    className: this._getPickerClass(As),
                  },
                  _t(
                    Ta,
                    s(
                      ...
                      t = _t(
                        ...
                        _t(ca, {
                          className:
                            ...
                            (a ? " mbsc-calendar-title-wrapper-multi" : ""),
                        }),
                        _t(ra, {
                          className:
                            "mbsc-calendar-button-prev" +
                            (a ? " mbsc-calendar-button-prev-multi" : ""),
                        }),
                        e.showToday &&
                          _t(la, { className: "mbsc-calendar-header-today" }),
                        _t(oa, {
                          className:
                            "mbsc-calendar-button-next" +
                            (a ? " mbsc-calendar-button-next-multi" : ""),
                        })
                      );
                    }
                    var i = _t(
                  ...
                  _t(
                    ...
                    _t(
                      ...
                      _t(
                        ...
                        e.downIcon &&
                          _t(Yn, {
                            svg: t.view === Fs ? e.downIcon : e.upIcon,
                            theme: e.theme,
                          })
                      )
                    ),
        ...
        (t.prototype._updated = function () {
          e.prototype._updated.call(this),
            this._shouldEnhanceHeader &&
              (yt(this._headerElement, { view: this }),
    ...
    Ra = (function () {
      function e() {
        (this.onInstanceReady = new c()), (this.onComponentChange = new c());
      }
      return (
    ...
    Fa = (function (e) {
      ...
      return (
        ...
        (t.prototype._template = function (e) {
          ...
          return _t(
            "div",
            s({ tabIndex: 0, ref: this._setEl, className: this._cssClass }, i),
            n
          );
        }),
        t
            ...
            this._unlisten = _s(t, {
              ...
              onMove: function (t) {
                ...
                (l.event = e._dragData),
                  ...
                  a
                    ? (o(t), (l.eventName = "onDragMove"), Ba.next(l))
      ...
      ? (function (e, t) {
          if (te) {
            var n = ee.createElement("script"),
              s = "mbscjsonp" + ++Ga;
            (te[s] = function (e) {
              n.parentNode.removeChild(n), delete te[s], e && t(e);
            }),
              (n.src = e + (e.indexOf("?") >= 0 ? "&" : "?") + "callback=" + s),
              ee.body.appendChild(n);
          }
        })(e, t)
      : (function (e, t) {
  ...
  function $a(e) {
    return (
      Ja || (Ja = ei.luxon.DateTime.local().zoneName),
      e && "local" !== e ? e : Ja
    );
  }
  b.http = Za;
  var Qa = (function () {
      function e(e, t) {
        void 0 === t && (t = "utc"), (this._mbsc = !0), (t = $a(t));
        var n = ei.luxon.DateTime,
          a = { zone: t };
        if (((this.zone = t), V(e))) this.dt = n.utc().setZone(t);
        else if (Qt(e) || A(e)) this.dt = n.fromMillis(+e, a);
        else if (F(e)) this.dt = n.fromISO(e, a);
        else if (Y(e)) {
          for (
            var i = [
                "year",
      ...
      return (
        ...
        (e.prototype.setHours = function (e, t, n, s) {
          return this.setter({ hour: e, minute: t, second: n, millisecond: s })
            .hour;
        }),
        ...
        (e.prototype.setTime = function (e) {
          return (this.dt = ei.luxon.DateTime.fromMillis(e)), this.dt.valueOf();
        }),
        (e.prototype.setTimezone = function (e) {
          (e = $a(e)), (this.zone = e), (this.dt = this.dt.setZone(e));
        }),
    ...
    ei = {
      luxon: H,
      parse: function (e, t) {
        return new Qa(e, t.dataTimezone || t.displayTimezone);
      },
      createDate: function (e, t, n, s, a, i, r, o) {
        ...
        return B(t) || F(t) || V(n)
          ? new Qa(t, l)
          : new Qa(
              [t || 1970, n || 0, s || 1, a || 0, i || 0, r || 0, o || 0],
              l
            );
      },
    };
  function ti(e) {
    return e && "local" !== e ? e : si.moment.tz.guess();
  }
  var ni = (function () {
      function e(e, t) {
        (this._mbsc = !0), (this.timezone = ti(t)), this.init(e);
      }
      return (
        (e.prototype.clone = function () {
        ...
        (e.prototype.setHours = function (e, t, n, s) {
          return this.m
            .set({ hours: e, minutes: t, seconds: n, milliseconds: s })
            .hours();
        }),
        (e.prototype.setDate = function (e) {
        ...
        (e.prototype.setTimezone = function (e) {
          (this.timezone = ti(e)), this.m.tz(this.timezone);
        }),
        (e.prototype.setUTCMilliseconds = function (e) {
          return 0;
        }),
    ...
    si = {
      moment: H,
      parse: function (e, t) {
        return new ni(e, t.dataTimezone || t.displayTimezone);
      },
      createDate: function (e, t, n, s, a, i, r, o) {
        var l = e.displayTimezone;
        return B(t) || F(t) || V(n)
    ...
    ai = 1;
  function ii(e, t, n, a, i, r) {
    var o = n,
      l = a,
      c = new Map(),
      h = [];
    i && (o = nn(i, t)), r ? (l = nn(r, t)) : i && (l = on(o, 1));
    var d = Ps(e, o, l, t);
    for (var u in d)
      if (u)
  ...
  function oi(e, t, n, s, a, i, r, o, l, c) {
    var h = t.color || (o && o.color),
      ...
      m = t.allDay || !_,
      p = u ? nn(u, m ? H : e) : null,
      v = t.end ? nn(t.end, m ? H : e) : null,
      f = Bt(e, t.allDay, p, v, l),
      g = p && f && !Jt(p, f),
      y = !g || Jt(p, d),
      b = !g || Jt(f, d),
      D = m || (!c && g && !y && !b),
    ...
    return {
      ...
      start: C,
      startDate: p,
      style: { background: h, color: s && h ? xe(h) : "" },
      title: T,
      tooltip: e.showEventTooltip ? t.tooltip || x : H,
  ...
  function li(e) {
    ...
    if (e)
      for (var n = 0, s = e; n < s.length; n++) {
        var a = s[n];
        a.id === H && (a.id = ri()), t.push(a);
      }
    return t;
  }
  function ci(e, t, n, s, a, i, r, o, l) {
    if ("start-end" === o) {
      var c = Ia(e, s, t, n, i, r),
        h = Ia(e, a, t, n, i, r);
      if (c) return c;
      if (h) return h;
    } else
      for (
        var d = l ? a : jt(on(a, 1)), u = jt(s);
        u < d;
        u.setDate(u.getDate() + 1)
      ) {
        var _ = Ia(e, u, t, n, i, r);
        if (_) return _;
      }
    return !1;
  }
  var hi = (function (e) {
        ...
        return (
          ...
          (t._onDayClick = function (e) {
            var n = +e.date,
              s = Xt(e.date),
              a = t.state,
              i = Js(t._eventMap[s], t.s.eventOrder),
              ...
              c =
                (o || l) &&
                (!a.showPopover || (a.showPopover && n !== a.popoverDate)) &&
                i &&
                i.length > 0;
            (e.events = i),
          ...
          (t._onActiveChange = function (e) {
            ...
            (t._active = n),
              ...
              (e.pageChange || e.today) &&
                ((s.selectedDate = n), t._selectedChange(new Date(n))),
              t.setState(s);
          }),
          (t._onGestureStart = function (e) {
            t._hidePopover();
          ...
          (t._onCellHoverIn = function (e) {
            (e.events = t._eventMap[Xt(e.date)]), t._hook("onCellHoverIn", e);
          }),
          (t._onCellHoverOut = function (e) {
            (e.events = t._eventMap[Xt(e.date)]), t._hook("onCellHoverOut", e);
          }),
          ...
          (t._onPageLoading = function (e) {
            var n = t.s,
              s = Ps(t._events, e.viewStart, e.viewEnd, n);
            (t._colorsMap = Ps(n.colors, e.viewStart, e.viewEnd, n)),
              (t._invalidsMap = Ps(n.invalid, e.viewStart, e.viewEnd, n, !0)),
              (t._validsMap = Ps(n.valid, e.viewStart, e.viewEnd, n, !0)),
              (t._eventMap = s),
              (t._firstDay = Kt(e.firstDay, n, t._firstWeekDay)),
          ...
          (t._onPageLoaded = function (e) {
            ...
            if (n && (!t._showCalendar || "day" !== s)) {
              var a = t.s,
                ...
                o = r ? i : e.firstDay,
                l = r
                  ? a.getDate(a.getYear(i), a.getMonth(i) + t._eventListSize, 1)
                  : e.lastDay;
              t._setEventList(o, l);
            }
          ...
          (t._getDragDates = function (e, n, s) {
            for (
              ...
              Jt(e, l) || c === i
                ? (a[Xt(l)] = {
                    event: s,
                    width: 100 * Math.min(Gt(l, r) + 1, 7 + i - c - h),
                  })
                : (a[Xt(l)] = {});
            }
            return a;
          ...
          (t._onLabelUpdateModeOn = function (e) {
            ...
            if (n) {
              ...
              t.setState({
                ...
                labelDragData: {
                  draggedEvent: n,
                  originDates: e.external ? H : t._getDragDates(s, a, n),
                },
              });
            }
          }),
          (t._onLabelUpdateModeOff = function (e) {
            t.setState({ isTouchDrag: !1, labelDragData: H });
          }),
          (t._onLabelUpdateStart = function (e) {
            var n = t.s,
              ...
              r = a.querySelectorAll(".mbsc-calendar-slide")[
                "all" === t._calendarLabelList || U(t._calendarLabelList)
                  ? 0
                  : 1
              ],
            ...
            if (
              ...
              c.forEach(function (n, s) {
                ...
                t._rowTops.push(a), e.endY - t._areaTop > a && (d = s);
              }),
              e.create)
            ) {
              var u = J(
                ...
                _ = on(t._firstDay, 7 * d + u),
                m = new Date(_.getFullYear(), _.getMonth(), _.getDate()),
                p = on(m, 1),
                v = n.exclusiveEndDates ? p : new Date(+p - 1),
                f = n.extendDefaultEvent
                  ? n.extendDefaultEvent({ start: m })
                  : H;
              t._tempEvent = s(
                {
                  allDay: !0,
          ...
          (t._onLabelUpdateMove = function (e) {
            ...
            if (
              ...
              t._rowTops.forEach(function (n, s) {
                e.startY - t._areaTop > n && (h = s),
                  e.endY - t._areaTop > n && (c = s);
              });
              var d = 7 * (c - h) + (o - l);
              if (o !== t._tempDay || c !== t._tempWeek) {
                ...
                if (e.external) {
                  var f = At(u),
                    g = +_ - +u;
                  (p = tn(n, +on(t._firstDay, 7 * c + o) + f)),
                    (v = tn(n, +p + g));
                } else if (e.drag) (p = on(u, d)), (v = on(_, d));
                else {
                  var y = n.rtl ? -1 : 1,
                    b = e.create
                      ? c === h
                ...
                (m.start = p),
                  ...
                  t.setState({
                    labelDragData: {
                      draggedDates: t._getDragDates(p, v, m),
                      draggedEvent: m,
          ...
          (t._onEventDragEnd = function (e) {
            var n = t.s,
              ...
              y = m.recurring;
            y
              ? (m.recurringException = Hs(m.recurringException).concat([p]))
              : ((m.allDay = g),
                (m.start = v),
                (m.end = f),
                i !== H && (m.resource = i),
            ...
            if (
              ((l || y) &&
                ...
                (b =
                  ...
                  t._hook(
                    "onEventCreate",
                    s(
                      { action: a, domEvent: e.domEvent, event: D, source: c },
                      y && { originEvent: d }
                    )
                  )),
                !1 !== o &&
                  ...
                  t._hook(
                    "onEventCreateFailed",
                    s(
                      { action: a, event: D, invalid: o, source: c },
                      y && { originEvent: d }
                    )
                  ))),
              (l && !y) ||
              ...
              b &&
                ((l || y) &&
                  (t._events.push(D),
                  (t._triggerCreated = { action: a, event: D, source: c })),
                (l && !y) ||
                  (y
                    ? ((h.id = D.id),
                      (h.original = D),
                      (u.recurringException = m.recurringException))
                    : ((u.start = v),
                      (u.end = f),
                      (u.allDay = g),
                      i !== H && (u.resource = i),
              ...
              t._showCalendar && "day" === t._scheduleType
                ? (k = jt(on((C = new Date(t._selected)), 1)))
                : ((C = t._firstDay), (k = t._lastDay)),
                (t._eventMap = Ps(t._events, C, k, n)),
                t.forceUpdate();
            }
            return b;
          }),
            ...
            if (t.s.dragToCreate || t.s.clickToCreate)
              if (n.recurring) {
                var a = n.original,
                  ...
                  r = s({}, a),
                  o = Pt(n.start, t.s);
                (r.recurringException = Hs(r.recurringException).concat([o])),
                  !1 !==
                    ...
                    ((a.recurringException = r.recurringException),
                    (t._triggerUpdated = {
                      event: a,
                      oldEvent: i,
                      source: e.source,
      ...
      return (
        ...
        (t.prototype.addEvent = function (e) {
          for (var t = [], n = 0, s = li(Y(e) ? e : [e]); n < s.length; n++) {
            var a = s[n];
        ...
        (t.prototype.getEvents = function (e, t) {
          return ii(this._events, this.s, this._firstDay, this._lastDay, e, t);
        }),
        ...
        (t.prototype.setEvents = function (e) {
          for (var t = [], n = li(e), s = 0, a = n; s < a.length; s++) {
            var i = a[s];
            t.push("" + i.id);
          }
        ...
        (t.prototype._render = function (e, t) {
          ...
          if (
            ((this._colorEventList =
              e.eventTemplate === H && e.renderEvent === H && e.colorEventList),
            e.exclusiveEndDates === H &&
              (e.exclusiveEndDates = !!e.displayTimezone),
            W(e.min)
              ? (this._minDate = -1 / 0)
              : r.min !== e.min && (this._minDate = +nn(e.min)),
            W(e.max)
              ? (this._maxDate = 1 / 0)
              : r.max !== e.max && (this._maxDate = +nn(e.max)),
            e.selectedDate !== H
              ? (s = +nn(e.selectedDate))
              : (this._defaultDate ||
                  (this._defaultDate = +(e.defaultSelectedDate !== H
                    ? nn(e.defaultSelectedDate)
                    : new Date())),
                (s = t.selectedDate || this._defaultDate)),
            (this.eventList = t.eventList),
            e.data !== r.data &&
              ((this._events = li(e.data)), (this._refresh = !0)),
            ...
            var h = e.firstDay,
              ...
              g = +(m.size || 1),
              y = m.type || "week",
              b = m.startDay !== H ? m.startDay : h,
              D = m.endDay !== H ? m.endDay : (h + 6) % 7,
              C = m.startTime,
              k = m.endTime,
              w = m.timeCellStep || 60,
              ...
              N = !!d.timeline,
              I = p.weekNumbers,
              O = p.startDay !== H ? p.startDay : h,
              P = p.endDay !== H ? p.endDay : (h + 6) % 7,
              z = p.startTime,
              Y = p.endTime,
              U = N && !!e.slots && e.slots.length > 0,
              A = p.eventList || U,
              F = +(p.size || 1),
              V = p.type || "week",
              B = "month" === V || A ? 1440 : 60,
              X = U ? B : p.timeCellStep || B,
              j = U ? B : p.timeLabelStep || B,
              q = _.type || "month",
              G =
                _.labels !== H
                  ? !!_.labels
            ...
            (this._calendarScroll = _.scroll),
              ...
              (this._showScheduleAllDay = m.allDay === H || m.allDay),
              (v === this._eventListSize &&
                f === this._eventListType &&
                x === this._showCalendar &&
                S === this._showEventCount &&
                G === this._showEventLabels &&
                E === this._showEventList &&
                ...
                w === this._scheduleTimeCellStep &&
                T === this._scheduleTimeLabelStep &&
                N === this._showTimeline &&
                O === this._timelineStartDay &&
                P === this._timelineEndDay &&
                z === this._timelineStartTime &&
                Y === this._timelineEndTime &&
                F === this._timelineSize &&
                V === this._timelineType &&
                X === this._timelineTimeCellStep &&
                j === this._timelineTimeLabelStep &&
                A === this._timelineListing) ||
                (this._refresh = !0),
              (this._eventListSize = v),
              (this._eventListType = f),
              (this._scheduleType = y),
              (this._showCalendar = x),
              (this._showEventCount = S),
              (this._showEventLabels = G),
              (this._showEventList = E),
              (this._showSchedule = M),
              ...
              (this._scheduleTimeCellStep = w),
              (this._scheduleTimeLabelStep = T),
              (this._showTimeline = N),
              (this._showTimelineWeekNumbers = I),
              (this._timelineSize = F),
              (this._timelineType = V),
              (this._timelineStartDay = O),
              (this._timelineEndDay = P),
              (this._timelineListing = A),
              (this._timelineStartTime = z),
              (this._timelineEndTime = Y),
              (this._timelineTimeCellStep = X),
              (this._timelineTimeLabelStep = j),
              (this._timelineRowHeight = p.rowHeight),
              (this._rangeType = M ? y : N ? V : f),
              (this._rangeStartDay = M ? b : N ? O : H),
              (this._rangeEndDay = M ? D : N ? P : H),
              (this._showDate =
                (M && "day" === y) || (E && "day" === f && v < 2)),
              (this._firstWeekDay = M ? b : N ? O : h),
              (this._viewChanged = !0);
          }
          if (
            ...
            e.refDate !== r.refDate && (this._refDate = nn(e.refDate)),
            this._refDate ||
              this._showCalendar ||
              (!this._showSchedule && !this._showTimeline) ||
              (this._refDate = jt(new Date())),
              ...
              (this._showSchedule || this._showTimeline || this._showEventList)
                ? +(function (e, t, n, s, a, i, r) {
                    var o,
                      ...
                      u = 0;
                    if (
                      (+e < n && (e = tn(t, n)), +e > s && (e = tn(t, s)), !a)
                    ) {
                      var _ = t.getYear(e),
                        m = t.getMonth(e),
                        p = t.getDate(_, m - 1, 1),
                        v = t.getDate(_, m + 2, 1);
                      (i = Ps(t.valid, p, v, t, !0)),
                        (a = Ps(t.invalid, p, v, t, !0));
                    }
                    if (!Ia(t, e, a, i, n, s)) return e;
                    for (o = e, l = e; c && +o < s && d < 100; )
                      (c = Ia(t, (o = on(o, 1)), a, i, n, s)), d++;
                    for (; h && +l > n && u < 100; )
                      (h = Ia(t, (l = on(l, -1)), a, i, n, s)), u++;
                    return 1 !== r || c
                      ? -1 !== r || h
                        ? Zt(e, o, t)
                          ? o
                        ...
                        : l
                      : o;
                  })(new Date(s), e, this._minDate, this._maxDate, H, H, 1)
                : R(s, this._minDate, this._maxDate);
            (K = this._getValidDay(K)),
              s !== K &&
                ((s = K),
                setTimeout(function () {
          ...
          ((n = +(a = jt(new Date(s)))) === this._selected &&
            ...
            (n === this._selected &&
              ...
              (this._shouldAnimateScroll =
                this._shouldAnimateScroll !== H
                  ? this._shouldAnimateScroll
                  : this._selected !== H),
              (this._selected = n),
              (this._selectedDates = {}),
              (this._selectedDates[+en(e, new Date(n))] = !0),
              (this._active = n),
              (c = !0)),
            c &&
              this._showCalendar &&
        ...
        (t.prototype._mounted = function () {
          this._unsubscribe = Xa(this._onExternalDrag);
        }),
        (t.prototype._updated = function () {
          var e = this;
          if (
            ...
            this._shouldLoadDays &&
              ...
              Ie(this._list.querySelectorAll("[mbsc-timestamp]"), function (t) {
          ...
          if (n && this._showEventList)
            for (
              var r = function (e) {
                  var t = n[Xt(e)];
                  if (t && t.length) {
                    var r = Js(t, i.eventOrder);
                    a.push({
                      date: sn(i.dateFormatLong, e, i),
        ...
        (t.prototype._getEventData = function (e, t) {
          ...
          if (!e.color && e.resource) {
            var a = Y(e.resource) ? e.resource : [e.resource];
        ...
        (t.prototype._getValidDay = function (e, t) {
          ...
          if (
            ...
            if (
              ...
              return +on(a, (r += t < 0 ? (r > 0 ? -7 : 0) : r < 0 ? 7 : 0));
          }
          return e;
        }),
        ...
        (t.prototype._dayClick = function (e, t) {
          var n = Xt(t.date),
            s = Js(this._eventMap[n], this.s.eventOrder);
  ...
  function ui(e, t, n, s, a, i) {
    for (
      ...
      for (var h = e[c[l]], d = jt(t); d < o; d.setDate(d.getDate() + 1)) {
        var u = h[Xt(d)];
        if (u) {
          if (u.allDay && (!r || Jt(d, t) || Jt(d, n))) return u.allDay;
          if (!s)
            for (var _ = 0, m = u.invalids; _ < m.length; _++) {
              var p = m[_];
              if (r) {
                if (Ft(p.startDate, p.endDate, t, t, !0)) return p.original;
                if (Ft(p.startDate, p.endDate, n, n)) return p.original;
              } else if (Ft(p.startDate, p.endDate, t, n)) return p.original;
            }
        }
      }
    return !1;
  ...
  function _i(e, t, n, s) {
    for (
      var a = n.allDay,
        i = n.startDate,
        r = a ? Bt(e, a, i, n.endDate) : n.endDate,
        o = a ? tn(e, i.getFullYear(), i.getMonth(), i.getDate()) : i,
        l = a
          ? tn(e, r.getFullYear(), r.getMonth(), r.getDate(), 23, 59, 59, 999)
          : r,
        c = !1,
        h = 0,
        d = t;
      ...
      for (
        var u = d[h], _ = 0, m = !1, p = void 0, v = 0, f = u;
        v < f.length;
        v++
      ) {
        for (var g = f[v], y = !1, b = 0, D = g; b < D.length; b++) {
          var C = D[b],
            k = C.allDay,
            w = C.startDate,
            T = k ? Bt(e, k, w, C.endDate) : C.endDate;
          Ft(
            k ? tn(e, w.getFullYear(), w.getMonth(), w.getDate()) : w,
            k
              ? tn(
                  e,
                  T.getFullYear(),
            ...
            ((y = !0),
            (m = !0),
            p ? (s[n.uid] = s[n.uid] || _) : (s[C.uid] = _ + 1));
        }
        y || p || (p = g), _++;
      }
      m && (p ? p.push(n) : u.push([n]), (c = !0));
    }
    c || ((s[n.uid] = 0), t.push([[n]]));
  }
  function mi(e) {
    return (e = Math.abs(K(e))) > 60
      ? 60 * K(e / 60)
      : 60 % e == 0
      ? e
  ...
  function pi(e, t, n, s, a, i) {
    s && s > e && (e = s);
    var r = At(e);
    return (
      (t > r || (a !== H && i !== H && !ln(e.getDay(), a, i))) && (r = t),
      (100 * (r - t)) / n
    );
  }
  function vi(e, t, n, s, a) {
    e = e || {};
    var i = Object.keys(e),
      r = {},
      o = t.map(function (e) {
  ...
  var gi = (function (e) {
        ...
        return (
          ...
          (t._onEventDragModeOn = function (e) {
            ...
            t.setState({
              dragData: {
                draggedEvent: n,
                originDates: e.external ? H : t._getDragDates(n, s, a),
                resource: s,
              },
              isTouchDrag: !0,
            });
          ...
          (t._onEventDragModeOff = function () {
            t.setState({ dragData: H, isTouchDrag: !1 });
          }),
          (t._calcGridDimensions = function () {
            var e = t.s,
              n = t._resources,
              s = t._isTimeline,
              a = t._days * (s ? 1 : n.length),
              i = t._gridCont,
              r = t._scrollCont,
          ...
          (t._onEventDragStart = function (e) {
            var n = t.s,
              ...
              _ = u ? t._days : t._hasSlots ? t._slots.length : r.length;
            (t._resWidth = t._resCont ? t._resCont.offsetWidth : 0),
              (t._scrollY = 0),
              (t._scrollX = 0),
              t._calcGridDimensions();
            var m = n.rtl ? t._gridRight - h : h - t._gridLeft,
              p = R(d - t._gridTop, 8, t._colHeight - 9),
              v = J(m / t._colWidth),
              f = 0,
              g = v,
              y = 0;
            if (i) {
              ...
              (t._rowTops = []),
                (y = J(m / (t._colWidth / o.length)) % o.length),
                b.forEach(function (e, n) {
                  var s = e.getBoundingClientRect().top - t._gridTop;
                  t._rowTops.push(s), p > s && (f = n);
                });
            } else {
              var D = t._el.querySelector(".mbsc-schedule-all-day-wrapper"),
                C = D && D.getBoundingClientRect();
              (t._allDayTop = C ? C.top : t._gridContTop),
                (f = u ? J(v / _) : v % _),
                (g = u ? v % _ : J(v / _));
            }
            if (e.create) {
              g = R(g, 0, t._days - 1);
              var k = e.click,
                w = !i && n.showAllDay && e.endY < t._gridContTop,
                T =
                  "day" === n.type && 1 === n.size
                    ? t._firstDay
                    : t._weekDays[g].dateObj,
                x = a || (!e.external && !k) ? l * Nt : t._stepCell,
                S = t._getGridTime(T, m, p, g, k ? t._stepCell / Nt : l),
                E = w || a ? T : S,
                M = on(E, 1),
                L = n.exclusiveEndDates ? M : new Date(+M - 1),
                N = w || a ? L : cn(tn(n, +E + x), k ? 1 : l),
                I = e.external ? H : r[f],
                O = I ? I.id : H,
                P = e.external ? H : o[y],
                z = P ? P.id : H,
                Y = n.extendDefaultEvent
                  ? n.extendDefaultEvent({ resource: O, slot: z, start: E })
                  : H,
                U = s(
                  {
                    allDay: w,
                ...
                A = t._getEventData(U, +T, I);
              if (e.event) {
                var F = +A.endDate - +A.startDate;
                (A.startDate = T), (A.endDate = new Date(+T + F));
              }
              (t._tempEvent = A), (t._tempResource = O), (t._tempSlot = z);
            }
          }),
          (t._onEventDragMove = function (e) {
            ...
            var n = t.s,
              ...
              _ = n.eventList,
              m = e.startX,
              p = R(e.endX, t._gridContLeft, t._gridContRight - 1),
              v = R(e.endY, t._gridContTop, t._gridContBottom - 1),
              f = v - e.startY + t._scrollY,
              g = a ? m - p + t._scrollX : p - m + t._scrollX,
              y = c ? g : f,
              ...
              C = R(v - t._gridTop + t._scrollY, 8, t._colHeight - 9),
              k = J((a ? t._gridRight - m : m - t._gridLeft) / t._colWidth),
              w = J(D / t._colWidth),
            ...
            if (
              ...
              P < 30 + (a ? 0 : t._resWidth) &&
                x.scrollLeft > A &&
                ((x.scrollLeft -= 5), (t._scrollX -= 5 * i), (N = !0)),
              z < 30 + (a ? t._resWidth : 0) &&
                x.scrollLeft < U &&
                ((x.scrollLeft += 5), (t._scrollX += 5 * i), (N = !0)),
              N &&
              ...
              (L = J(D / (t._colWidth / o.length)) % o.length),
                t._rowTops.forEach(function (e, t) {
                  C > e && (M = t);
                });
            else {
              var F = l ? r : t._resources.length;
              (S = l ? k % F : J(k / F)),
                (E = l ? w % F : J(w / F)),
                (M = l ? J(w / F) : w % F);
            }
            (S = R(S, 0, r - 1)), (E = R(E, 0, r - 1));
            var W,
              V = e.create ? t._tempEvent : e.event,
              B = V.startDate,
              X = V.endDate,
              j = +X - +B,
              q = t._time,
              ...
              te = B,
              ne = X,
              se = t._weekDays[S].dateObj,
              ae = t._weekDays[E].dateObj,
              ie = "day" === n.type && 1 === n.size ? 0 : Gt(se, ae),
              re = ie - E + S;
            if (e.drag || e.external) {
              if (
                ...
                (ee = T || _ || (c && V.allDay)),
                (Q = $ ? H : n),
                (V.allDay && !c && !T) || (e.external && !T))
              ) {
                var oe = jt(on(B, ie));
                te = t._getGridTime(oe, D, C, E, d);
              } else
                c && !ee
                  ? (te = cn(tn(n, +B + G + (Ht - q) * ie + q * re), d))
                  : ((W = on(B, ie)), (te = ee ? W : cn(tn(Q, +W + G), d)));
              ne = tn(Q, +te + j);
            } else {
              var le = c ? 0 : w - k,
              ...
              !c &&
                ...
                h.draggedEvent &&
                (ie =
                  Gt(h.draggedEvent.startDate, h.draggedEvent.endDate) *
                  (ce ? 1 : -1)),
                ce
                  ? c && !ee
                    ? (ne = cn(tn(n, +X + G + ie * (Ht - q) + q * re), d))
                    : ((W = on(X, Math.max(-he, ie))),
                      (ne = ee ? W : cn(tn(Q, +W + G), d)),
                      !ee &&
                        (At(ne) > t._endTime + 1 || ne >= on(jt(W), 1)) &&
                        (ne = tn(n, +jt(W) + t._endTime + 1)))
                  : c && !ee
                  ? (te = cn(tn(n, +B + G + ie * (Ht - q) + q * re), d))
                  : ((W = on(B, Math.min(he, ie))),
                    (te = ee ? W : cn(tn(Q, +W + G), d)),
                    !ee &&
                      (At(te) < t._startTime || te < jt(W)) &&
                      (te = tn(n, +jt(W) + t._startTime))),
                (Z = de),
                ee && ne < te && (ce ? (ne = tn(n, te)) : (te = tn(n, ne))),
                !ee &&
                  (ne < te || Math.abs(+ne - +te) < d * Nt) &&
                  (ce
                    ? (ne = tn(n, +te + d * Nt))
                    : (te = tn(n, +ne - d * Nt)));
            }
            if (
              ...
              (ue.startDate = te),
                ...
                t.setState({
                  dragData: {
                    draggedDates: t._getDragDates(ue, Z, K),
                    draggedEvent: ue,
          ...
          (t._onEventDragEnd = function (e) {
            ...
            var n = t.s,
              ...
              i = a.dragData;
            if (
              (s && !i && ((i = {}).draggedEvent = t._tempEvent),
              i && i.draggedEvent)
            ) {
              var r = e.event,
                o = i.draggedEvent,
                ...
                d = o.original,
                u = e.resource,
                _ = i.resource === H ? u : i.resource,
                m = d.resource === H ? _ : d.resource,
                p = s ? t._tempSlot : e.slot,
                v = i.slot === H ? p : i.slot,
                f = {},
                g =
                  s ||
              ...
              if (u !== _ && !s && !t._isSingleResource)
                if (Y(m) && m.length && _) {
                  var D = m.indexOf(u);
                  -1 === m.indexOf(_) && (y = m.slice()).splice(D, 1, _);
                } else y = _;
              b =
                y && n.resources
                  ? Y(y)
              ...
              for (var C = 0, k = b; C < k.length; C++) {
                var w = k[C];
                t._invalids[w] && (f[w] = t._invalids[w][v]);
              }
              var T =
                  !g ||
                  n.onEventDragEnd({
                    action: e.action || (a.dragData ? "drag" : "click"),
                    collision: ui(
                      f,
                      l,
                      c,
                ...
                x = a.isTouchDrag && (!s || T);
              if (T && x && u !== _ && !d.color) {
                var S = Q(t._resources, function (e) {
                    return e.id === _;
                  }),
                  E = S && S.color;
                E
              ...
              t.setState({
                dragData: x
                  ? {
                      draggedEvent: o,
                      originDates: T ? t._getDragDates(o, _, v) : i.originDates,
                    }
                  : H,
                isTouchDrag: x,
              }),
      ...
      return (
        ...
        (t.prototype._formatTime = function (e) {
          ...
          return sn(
            /a/i.test(t) && this._stepLabel === It && e % It == 0
              ? t.replace(/.[m]+/i, "")
              : t,
            new Date(+Lt + e)
          );
        ...
        (t.prototype._getEventPos = function (e, t, n) {
          var s = this.s,
            a = e.allDay ? H : s,
            i = tn(a, t.getFullYear(), t.getMonth(), t.getDate()),
            r = a ? this._firstDayTz : this._firstDay,
            o = a ? this._lastDayTz : this._lastDay,
            l = this._isTimeline,
            c = !l && !this._groupByResource,
            h = e.allDay,
            d = this._startTime,
            u = this._endTime,
            _ = e.start,
            m = e.startDate,
            p = e.end,
            v = Bt(s, h, m, e.endDate),
            f = +m == +v ? 1 : 0;
          if (h || l) {
            if (!n.get(e.original) || this._hasSlots || c) {
              var g = s.startDay,
                y = s.endDay,
                b = !Jt(m, v);
              l &&
                b &&
                At(m) > u &&
                (m = new Date(m)).setHours(J(u / It), J(u / Nt) % 60);
              var D = s.eventList,
                C = pi(m, d, this._time, r, g, y) + "%",
                k = (function (e, t, n, s, a, i, r, o, l, c) {
                  var h = rn(e),
                    d = rn(t),
                    u = J(i / It),
                    _ = J(i / Nt) % 60,
                  ...
                  +e < +s && (h = s),
                    +t > +a && (d = a),
                    i > At(h) && h.setHours(u, _),
                    r < At(d) && d.setHours(m, p),
                    Jt(h, d) ||
                      (At(h) > r && h.setHours(m, p),
                      At(d) < i && d.setHours(u, _));
                  var v = 0;
                  if (Jt(h, d)) v = c ? n : At(d) - At(h);
                  else
                    for (var f = jt(h); f <= d; f.setDate(f.getDate() + 1))
                      ln(f.getDay(), o, l) &&
                        (!c && Jt(f, h)
                          ? (v += n - At(h) + i)
                          : !c && Jt(f, d)
                          ...
                          : (v += n));
                  return (100 * v) / n;
                })(m, v, this._time, r, o, d, u, g, y, h || D),
                w = l
                  ? D || h
                    ? {
                        left: s.rtl ? "" : "0",
                        right: s.rtl ? "0" : "",
                        width: (this._hasSlots ? 100 : k) + "%",
                      }
                    : {
              ...
              if (h || D || (b && (T || x)) || (T && x))
                return (
                  n.set(e.original, !0),
                  { end: p, endDate: v, position: w, start: _, startDate: m }
                );
            }
          } else if (
            (m < i && ((_ = ""), (m = tn(s, i))),
            v >= jt(on(i, 1)) &&
              ((p = ""), (v = tn(s, i)).setHours(23, 59, 59, 999)),
            At(m) < u && At(v) + f > d && v >= m)
          ) {
            var S = (function (e, t, n, s, a) {
              var i = At(e),
                r = At(t);
        ...
        (t.prototype._getEventData = function (e, t, n) {
          ...
          return (
            (a.html = this._safeHtml(a.html)),
            e.allDay &&
              s.exclusiveEndDates &&
              +a.endDate == +a.startDate &&
              (a.endDate = jt(on(a.startDate, 1))),
            a
          );
        }),
        (t.prototype._getEvents = function (e, t, n) {
          for (
            var s = this,
              ...
              d = [],
              u = {},
              _ = vi(n, r, o, !!a.resources, !!a.slots),
              m = {},
              p = {},
              v = [],
              f = function (n) {
                var r = n.id,
                  f = new Map(),
                  y = 0;
                if (((m[r] = []), (l || c) && ((v = []), d.push(v), !c || h)))
                  for (var b = 0, D = o; b < D.length; b++) {
                    var C = D[b].id,
                      k = _[r][C];
                    p[C] = Ks(
                      a,
                ...
                for (
                  var w = function (e) {
                      if (ln(e.getDay(), a.startDay, a.endDay)) {
                        var b = +jt(e),
                          D = Xt(e);
                        if (!l && !c) {
                          u[D] ? (v = u[D]) : ((v = []), (u[D] = v), d.push(v));
                          var C = _[r][di];
                          p[di] = Ks(
                            a,
                            C,
                          ...
                          for (
                            var w = function (t) {
                                var a = t.id,
                                  i = 0;
                                (k.events[a] = []),
                                  p[a][D].data.forEach(function (t) {
                                    var r = t.event,
                                      o = t.width;
                                    if (r) {
                                      var l = h ? k.events[a] : k.allDay,
                                        c = s._getEventData(r, b, n),
                                        d = s._getEventPos(c, e, f);
                                      (c.position = {
                        ...
                        if (!h) {
                          var M = Js(_[r][di][D]) || [];
                          k.events[di] = [];
                          for (var L = 0, N = M; L < N.length; L++) {
                            var I = N[L];
                            if (!I.allDay || c) {
                              var H = g._getEventData(I, b, n),
                                O = g._getEventPos(H, e, f);
                              O &&
                                ((H.cssClass = O.cssClass),
                                (H.position = O.position),
                                c || _i(a, S, H, E),
                                k.events[di].push({ event: H, showText: !0 }),
                                m[r].push(H));
                            }
                          }
                        }
                                ...
                                e.forEach(function (e, n) {
                                  for (var s = 0, i = e; s < i.length; s++) {
                                    var r = i[s],
                                      o = (((E[r.uid] || t) - n) / t) * 100;
                                    (r.position.width = o + "%"),
                                      (r.position[a.rtl ? "right" : "left"] =
                                        (100 * n) / t + "%"),
                                      (r.position[a.rtl ? "left" : "right"] =
                                        "auto");
                                  }
                                });
                              },
                ...
                if (c && !h) {
                  for (
                    var x = [], S = {}, E = g._setRowHeight, M = 0, L = m[r];
                    M < L.length;
                    M++
                  ) {
                    var N = L[M];
                        ...
                        E && t > y && (y = t),
                          e.forEach(function (e, n) {
                            for (var s = 0, a = e; s < a.length; s++) {
                              var i = a[s],
                                r = (((S[i.uid] || t) - n) / t) * 100;
                              (i.position.height = E ? "" : r + "%"),
                                (i.position.top = E ? n : (100 * n) / t + "%");
                            }
                          });
                      },
                      H = 0,
        ...
        (t.prototype._getInvalids = function (e, t, n) {
          for (
            var s = this.s,
              a = s.eventList,
              i = {},
              r = vi(n, this._resources, this._slots, !!s.resources, !!s.slots),
              o = a ? jt(new Date(s.minDate)) : new Date(s.minDate),
              l = a ? jt(on(new Date(s.maxDate), 1)) : new Date(s.maxDate),
              c = 0,
              h = this._resources;
            c < h.length;
            c++
            ...
            for (
              var d = h[c], u = d.id, _ = new Map(), m = jt(e);
              m < t;
              m.setDate(m.getDate() + 1)
            )
              for (var p = Xt(m), v = 0, f = this._slots; v < f.length; v++) {
                var g = f[v].id,
                  y = r[u][g][p] || [],
                  b = { invalids: [] };
                m < o && y.push({ end: o, start: new Date(m) }),
                  m >= jt(l) && y.push({ end: new Date(t), start: l });
                for (var D = 0, C = y; D < C.length; D++) {
                  var k = C[D];
                  if (F(k) || Qt(k)) {
                    var w = nn(k);
                    k = { allDay: !0, end: new Date(w), start: w };
                  }
                  var T = this._getEventData(k, +m, d);
                  if (((T.cssClass = ""), (T.position = H), !T.allDay)) {
                    var x = this._getEventPos(T, m, _);
                    x &&
                      (!this._isTimeline &&
                      0 === At(x.startDate) &&
                      new Date(+x.endDate + 1) >= on(m, 1)
                        ? (T.allDay = !0)
                        : ((T.position = x.position),
                          At(x.startDate) <= this._startTime &&
                            (T.cssClass += " mbsc-schedule-invalid-start"),
                          At(x.endDate) >= this._endTime &&
                            (T.cssClass += " mbsc-schedule-invalid-end"))),
                      b.invalids.push(T);
                  }
                  if (T.allDay) {
                    (T.position = {}), (b.allDay = T), (b.invalids = [T]);
                    break;
                  }
                }
                i[u] || (i[u] = {}),
        ...
        (t.prototype._getColors = function (e, t, n) {
          for (
            var s = this.s,
              a = {},
              i = vi(n, this._resources, this._slots, !!s.resources, !!s.slots),
              r = 0,
              o = this._resources;
            r < o.length;
            r++
            ...
            for (
              ...
              for (
                ...
                for (
                  ...
                  var b = y[g],
                    D = this._getEventData(b, p, l);
                  if (D.allDay && !this._isTimeline) f.allDay = D;
                  else {
                    var C = this._getEventPos(D, m, h);
                    C &&
                      ((D.position = C.position),
                      (D.cssClass = ""),
                      At(C.startDate) <= this._startTime &&
                        (D.cssClass += " mbsc-schedule-color-start"),
                      At(C.endDate) >= this._endTime &&
                        (D.cssClass += " mbsc-schedule-color-end"),
                      f.colors.push(D));
                  }
                  (D.position.background = b.background),
                    (D.position.color = b.textColor
                      ? b.textColor
                      : xe(b.background));
                }
                a[c] || (a[c] = {}),
        ...
        (t.prototype._render = function (e, t) {
          ...
          if (
            ...
            var g = nn(e.startTime || "00:00"),
              y = new Date(+nn(e.endTime || "00:00") - 1);
            (this._startTime = v = At(g)),
              (this._endTime = f = At(y)),
              (this._time = f - v + 1),
              (this._timesBetween = X(J(o / r) - 1)),
              (this._times = []);
            for (var b = o * Nt, D = J(v / b) * b; D <= f; D += b)
              this._times.push(D);
            p = !0;
          }
          if (
            ...
            if (i > 1 || k) {
              ...
              (w = Bs(M, E)),
                ...
                "week" === e.type &&
                  ((w = on(w, c - l + (c < l ? 7 : 0))),
                  (T = on(w, 7 * i + h - c + 1 - (h < c ? 0 : 7)))),
                (x = w),
                (S = T);
            } else {
              (x = on(Kt(a, e), c - l + (c < l ? 7 : 0))),
                (S = on(x, h - c + 1 + (h < c ? 7 : 0))),
                (w = C ? jt(a) : x),
                (T = C ? on(w, 1) : S);
            }
            (this._dayRefs = []),
              ...
              (this._selectedDay = +jt(a)),
              (this._setRowHeight = e.eventList || "equal" !== e.rowHeight),
              (this._shouldAnimateScroll = n.selected !== H),
              (this._showTimeIndicator =
                !k &&
                !e.eventList &&
                (C ? Jt(new Date(), a) : w <= new Date() && T >= new Date())),
              (this._weekDays = []);
            var L = e.dateFormat.search(/m/i),
              N = e.dateFormat.search(/y/i) < L,
              I = 0,
              O = 0,
              P = -1,
              z = -1,
              ...
              F = w,
              W = T;
            !s && C && i < 2 && this._groupByResource && ((F = x), (W = S));
            for (D = jt(F); D < jt(W); D.setDate(D.getDate() + 1))
              if (ln(D.getDay(), c, h)) {
                var V = "",
                  B = "";
                if (s) {
                  var j = e.getWeekNumber(on(D, (7 - l + 1) % 7));
                  if (P !== e.getMonth(D)) {
                    -1 !== z && (this._dayRefs[z].monthDays = R),
                      (R = 0),
                      (z = I),
                      (P = e.getMonth(D));
                    var q = e.getYear(D),
                      G = e.monthNames[P];
                    (V = N ? q + " " + G : G + " " + q),
                      I > 0 && (this._weekDays[I - 1].last = !0);
                  }
                  (0 !== I && Y === j) ||
                    (-1 !== U && (this._dayRefs[U].weekDays = A),
                    (A = 0),
                    (U = I),
                    (Y = j),
                    (B = e.weekText.replace(/{count}/, Y)),
                    I > 0 && (this._weekDays[I - 1].lastWeek = !0));
                }
                this._dayRefs.push({ monthIndex: z, weekIndex: U }),
                  this._weekDays.push({
                    date: sn(
                      k || this._isMulti ? "D DDD" : e.dateFormatLong,
                      D,
                      e
                    ),
                    dateKey: Xt(D),
          ...
          (e.colorsMap !== n.colorsMap || p) &&
            (this._colors = this._getColors(
              this._firstDay,
              this._lastDay,
              e.colorsMap
            )),
            (e.eventMap === n.eventMap && !p && this._events) ||
              ((this._eventRows = {}),
          ...
          (e.height !== n.height || e.width !== n.width || K || p) &&
            (this._shouldCheckSize = u && !!e.height && !!e.width),
            e.scroll !== n.scroll && (this._shouldScroll = !0),
            (this._hasSticky = fe && !e.rtl),
            (this._hierarchyChange = !1),
            (this._stepCell = o * Nt),
            (this._stepLabel = r * Nt),
            (this._dayNames =
        ...
        (t.prototype._mounted = function () {
          ...
          (this._unlisten = _s(this._el, {
            ...
            onEnd: function (n) {
              !e &&
                t &&
                "single" === s.s.clickToCreate &&
                ((e = !0), (n.click = !0), s._onEventDragStart(n)),
            ...
            onStart: function (a) {
              ...
              if (
                ...
                var r =
                  (a.domEvent.target && a.domEvent.target.classList) || [];
                (n =
                  ...
                  (a.isTouch && i.dragToCreate
                    ? (s._touchTimer = setTimeout(function () {
                        s._onEventDragStart(a),
                          s._onEventDragModeOn(a),
                          (e = !0);
                      }, 350))
                    : (t = !a.isTouch));
              }
        ...
        (t.prototype._updated = function () {
          ...
          if (
            ...
            if (this._isTimeline) {
              ...
              var r = a.offsetHeight - a.clientHeight;
              if (
                ...
                var o = a.querySelector(".mbsc-schedule-event");
                o && (i = o.clientHeight);
              }
            } else {
            ...
            this._onScroll(),
              ...
              setTimeout(function () {
                e.setState({
                  ...
                  dayNameWidth: s,
                  eventHeight: i,
                  hasScrollX: a.scrollWidth > a.clientWidth,
                  hasScrollY: a.scrollHeight > a.clientHeight,
                });
              });
          }
        }),
        (t.prototype._destroy = function () {
          this._unlisten(), ja(this._unsubscribe);
        }),
        (t.prototype._getDragDates = function (e, t, n) {
          ...
          for (
            l = (l = jt(l)) < o ? o : l,
              c = a.exclusiveEndDates || !e.allDay ? c : jt(on(c, 1));
            l < c || !h;

          ) {
            var d = s({}, e),
              u =
                ln(l.getDay(), a.startDay, a.endDay) &&
                this._getEventPos(e, l, r);
            u &&
              ((d.cssClass = u.cssClass),
              (d.start = u.start),
              (d.end = u.end),
              (d.position = u.position),
              (i[t + "__" + (this._isTimeline ? n + "__" : "") + Xt(l)] = d)),
              (l = on(l, 1)),
              (h = 1);
          }
          return i;
        ...
        (t.prototype._getGridTime = function (e, t, n, s, a) {
          var i,
            ...
            o =
              ((i = this._isTimeline
                ? J((this._time * (t - s * this._colWidth)) / this._colWidth)
                : J((this._time * (n - 8)) / (this._colHeight - 16))),
              J(i / (r = a * Nt)) * r),
            l = new Date(+Lt + this._startTime + o);
          return tn(
            this.s,
            e.getFullYear(),
            e.getMonth(),
        ...
        (t.prototype._scrollToTime = function (e) {
          ...
          if (t) {
            var s = this.s,
              a = tn(s, s.selected);
            a.setHours(s.eventList ? 0 : a.getHours(), 0);
            var i = pi(a, this._startTime, this._time * (n ? this._days : 1)),
              r = void 0;
            if (n) {
              var o = (100 * Gt(this._firstDay, a)) / this._days + i;
          ...
          for (var n = 0, s = e; n < s.length; n++) {
            ...
            t.push(a),
              a.children &&
                ...
                a.collapsed || this._flattenResources(a.children, t));
          }
          return t;
        }),
        t
        ...
        return (
          ...
          (t._onDocTouch = function (e) {
            ye(t._doc, es, t._onDocTouch),
              ye(t._doc, qn, t._onDocTouch),
              (t._isDrag = !1),
              t._hook("onDragModeOff", { event: t.s.event });
          }),
          (t._updateState = function (e) {
            t.setState(e);
          }),
      ...
      return (
        ...
        (t.prototype._render = function (e, t) {
          var n = new Date(e.timestamp),
            ...
            y = At(o),
            b = l && e.slot !== di,
            D = new Date(e.lastDay),
            C = ln(o.getDay(), e.startDay, e.endDay);
          (this._isStart = b || !d || u),
          ...
          if (k) {
            var w = k(a);
            F(w)
              ? ((this._html = this._safeHtml(w)), (this._shouldEnhance = !0))
              : (this._content = w);
        ...
        (t.prototype._destroy = function () {
          if ((this._el && this._el.blur(), this._unsubscribe)) {
            var e = this.s.event.uid,
              t = yi[e];
            t.unsubscribe(this._unsubscribe), t.nr || delete yi[e];
          }
          this._unlisten && this._unlisten(),
            ye(this._doc, es, this._onDocTouch),
            ye(this._doc, qn, this._onDocTouch);
            ...
            e.render
              ...
              : _t(
                  ...
                  !n &&
                    !s &&
                    _t("div", {
                      className: "mbsc-schedule-event-bar" + a + this._rtl,
                    }),
                  _t("div", {
                    className:
                  ...
                  _t(
                    ...
                    !n &&
                      _t(
                        "div",
                        { className: "mbsc-schedule-event-range" + a },
                        this._rangeText
                      )
                  )
                )
    ...
    Ci = (function (e) {
      ...
      return (
        ...
        (t.prototype._render = function (t, n) {
          ...
          var s = this._stepCell / Nt,
            a = J(this._startTime / Nt) % s,
            i = (J(this._endTime / Nt) % s) + 1;
          (this._largeDayNames = n.dayNameWidth > 99),
            (this._startCellStyle =
              a % s != 0
                ? { height: (n.cellHeight || 50) * (((s - a) % s) / s) + "px" }
                : H),
            (this._endCellStyle =
              i % s != 0
                ? { height: ((n.cellHeight || 50) * (i % s)) / s + "px" }
                : H);
        }),
        t
      );
        ...
        (t.prototype._render = function (e) {
          ...
          (this._time = sn(e.timeFormat, t)),
            (this._cssClass =
              ...
              this._rtl +
              " " +
              (r < i || r > i + a || !ln(t.getDay(), e.startDay, e.endDay)
                ? " mbsc-hidden"
                : ""));
          for (
            var o = -1, l = jt(e.firstDay);
            l <= jt(t);
            l.setDate(l.getDate() + 1)
          )
            ln(l.getDay(), e.startDay, e.endDay) && o++;
          if ("x" === e.orientation) {
            var c = (100 * o) / s + "%";
            (this._pos = { top: (100 * (r - i)) / a + "%" }),
              (this._dayPos = {
                left: n ? "" : c,
                right: n ? c : "",
                width: 100 / s + "%",
            ...
            var h = (100 * (o * a + r - i)) / (s * a) + "%";
            this._pos = { left: n ? "" : h, right: n ? h : "" };
          }
        }),
        t
      );
      ...
      return (
        ...
        (t.prototype._template = function (e, t) {
          ...
          return (
            ...
            F(n) &&
              ((n = _t("div", { dangerouslySetInnerHTML: this._safeHtml(n) })),
              (this._shouldEnhance = !0)),
            _t(
              "div",
              {
            ...
            k = function (t, a, o, l, c, h) {
              ...
              return _t(
                ...
                i &&
                  i.originDates &&
                  i.originDates[_] &&
                  !!i.originDates[_].allDay == !!h &&
                  _t(
                    Di,
                    s({}, m, {
                      event: i.originDates[_],
                ...
                i &&
                  i.draggedDates &&
                  i.draggedDates[_] &&
                  !!i.draggedDates[_].allDay == !!h &&
                  _t(Di, s({}, m, { event: i.draggedDates[_], isDrag: !0 }))
              );
            };
          return _t(
            "div",
            ...
            _t(
              ...
              _t("div", { className: "mbsc-schedule-fake-scroll-y" })
            ),
            _t(
              "div",
              {
                ...
                _t(
                  ...
                  _t(
                    ...
                    _t(
                      ...
                      {
                        className:
                          "mbsc-flex-col mbsc-flex-1-1 mbsc-schedule-time-cont-pos",
                      },
                      h.map(function (e, t) {
                        var s = h.length - 1;
                        return _t(
                          ...
                          _t(
                            ...
                            {
                              className:
                                "mbsc-flex-1-1 mbsc-schedule-time" + v + c,
                            },
                            0 === t || e % p == 0
                              ? n._formatTime(0 === t ? d : e)
                              : ""
                          ),
                          n._timesBetween.map(function (t, s) {
                            var a = e + (s + 1) * p;
                            return (
                              a > d &&
                              a < u &&
                          ...
                          t === s &&
                            _t(
                              ...
                              {
                                className:
                                  "mbsc-schedule-time mbsc-schedule-time-end" +
                                  v +
                                  c,
                              },
                              n._formatTime(u + 1)
                    ...
                    t.hasScrollX &&
                      _t("div", { className: "mbsc-schedule-fake-scroll-x" })
                  ),
                  _t("div", { className: "mbsc-schedule-fake-scroll-y" })
                )
              ),
                          ...
                          return _t(
                            ...
                            _t(
                              ...
                              _t(
                                ...
                                k(t.events[di], i, t.lastDay, s, r)
                              ),
                              o[r][di][i].invalids.map(function (e, t) {
                                return (
                                  e.position &&
                                  _t(
                                    "div",
                                    ...
                                    _t(
                                      ...
                                      o[r][di][i].allDay ? "" : e.title || ""
                                    )
                                  )
                                );
                              }),
                              a[r][di][i].colors.map(function (e, t) {
                                return _t(
                                  "div",
                                  {
                                    key: t,
            ...
            i &&
              !t.isTouchDrag &&
              _t("div", { className: "mbsc-calendar-dragging" })
          );
        }),
        t
      );
  ...
  var Ei = (function (e) {
        ...
        return (
          ...
          (t._onScroll = function () {
            var e = t.s,
              ...
              o = t._headerCont,
              l = fe && !e.rtl,
              c = (pe ? pe + "T" : "t") + "ransform";
            if ((r && !l && (r.scrollTop = s), o)) {
              var h = i.offsetWidth,
                d = t._isMulti,
                u = t._hasSlots || t._stepCell < 864e5,
                _ = e.weekNumbers;
              t._daySticky(e.rtl, t._dayRefs, a, h / t._days, d, u, _),
                (o.style[c] = "translateX(" + -a + "px)");
            }
          }),
          t
        );
      ...
      return (
        ...
        (t.prototype._render = function (t, n) {
          ...
          var s,
            ...
            g,
            y = this._stepCell / Nt,
            b = J(this._startTime / Nt) % y,
            D = (J(this._endTime / Nt) % y) + 1;
          (this._startCellStyle =
            this._displayTime && b % y != 0
              ? { width: (n.cellWidth || 40) * (((y - b) % y) / y) + "px" }
              : H),
            (this._endCellStyle =
              this._displayTime && D % y != 0
                ? { width: ((n.cellWidth || 40) * (D % y)) / y + "px" }
                : H),
            this._daySticky ||
              (this._daySticky = function (e, t, n, y, b, D, C) {
                var k = e ? -1 : 1,
                  w = e ? "marginRight" : "marginLeft",
                  T = t !== a || y !== g,
                  x = Math.max(J(Math.abs(n) / y), 0),
                  S = l,
                  E = _;
                (g = y),
                  (x !== s || T) &&
                  ...
                  i &&
                    D &&
                    (i.style[w] = Math.min(k * (n - k * r), y - o - 3) + "px"),
                  h &&
                    (h.style[w] =
                      Math.max(0, Math.min(k * (n - k * d), c - u - 3)) + "px"),
                  p &&
                    (p.style[w] =
                      Math.max(0, Math.min(k * (n - k * v), m - f - 3)) + "px");
              });
        }),
        t
      );
                ...
                t.map(function (t) {
                  return _t(
                    ...
                    (function (t, n) {
                      var s,
                        a = t.children,
                        r = i._hasHierarchy ? 1.75 * n + "em" : H,
                        o = {
                          minHeight: i._setRowHeight
                            ? i._eventRows[t.id] * i._eventHeight + 10
                            : H,
                          paddingLeft: e.rtl ? H : r,
                          paddingRight: e.rtl ? r : H,
                        },
                        l = t.name;
                      return (
                        e.renderResource &&
                          F((l = e.renderResource(t))) &&
                          ((s = i._safeHtml(l)), (i._shouldEnhance = !0)),
                        _t(
                          "div",
                          {
                            key: t.id,
            ...
            T = function (t) {
              return t.map(function (t) {
                return _t(
                            ...
                            return _t(
                              "div",
                              {
                                ...
                                className:
                                  ...
                                  (i._hasSlots ? " mbsc-timeline-slot" : ""),
                              },
                              _t(
                                "div",
                                { className: "mbsc-timeline-events" },
                                t.events[k].map(function (t) {
                                  var n = t.event;
                                  return t.showText
                                    ? _t(
                                        Di,
                                ...
                                o &&
                                  ...
                                  _t(
                                    Di,
                                    s({}, T, {
                                      event: o.draggedDates[w],
                                      isDrag: !0,
                                    })
                                  )
                              ),
                              c[a][k][y].invalids.map(function (e, t) {
                                return (
                                  e.position &&
                                  _t(
                                    "div",
                                    ...
                                    _t(
                                      ...
                                      c[a][k][y].allDay ? "" : e.title || ""
                                    )
                                  )
                                );
                              }),
                              r[a][k][y].colors.map(function (e, t) {
                                return _t(
                                  "div",
                                  {
                                    key: t,
                  ...
                  })(t, i._resources.indexOf(t)),
                  !t.collapsed && t.children && _t("div", null, T(t.children))
                );
              });
            };
          return _t(
            ...
            _t("div", { className: "mbsc-flex-none" + k }),
            _t(
              "div",
              { className: "mbsc-timeline-header mbsc-flex" + _ + d + h },
              y &&
                _t(
                  "div",
                  {
                ...
                _t(
                  ...
                  this._weekDays.map(function (t, n) {
                    return _t(
                      ...
                      _t(
                        "div",
                        { className: "mbsc-timeline-header-date" + _ + d + h },
                        _t(
                          "div",
                          {
                        ...
                        u.map(function (e, t) {
                          return _t(
                            ...
                            _t(
                              ...
                              !i._displayTime || (0 !== t && e % v != 0)
                                ? ""
                                : i._formatTime(0 === t ? m : e)
                            ),
            ...
            _t(
              ...
              _t(
                ...
                !this._hasSticky &&
                  y &&
                  _t("div", { className: "mbsc-timeline-resource-col" }),
                _t(
                  "div",
                  { className: "mbsc-flex-col mbsc-flex-1-1" },
                  _t(
      ...
      return (
        ...
        (t.prototype._eventRenderer = function (e, t, n, s, a) {
          ...
          F(d)
            ...
            : (d = _t("div", { className: "mbsc-event-content" + h }, d));
          var u = s.renderEvent
            ? s.renderEvent(e)
            : _t(
                Fe,
                ...
                _t(
                  ...
                  e.lastDay &&
                    _t("div", { className: "mbsc-event-until" + h }, e.lastDay),
                  e.start &&
                    _t("div", { className: "mbsc-event-start" + h }, e.start),
                  e.start &&
                    e.end &&
                    _t("div", { className: "mbsc-event-sep" + h }, "-"),
                  e.end && _t("div", { className: "mbsc-event-end" + h }, e.end)
                )
              );
          return (
            F(u) &&
              ((i = { __html: u }), (u = H), (this._shouldEnhance = c && l)),
            _t(
              Fa,
              {
            ...
            this._showDate &&
              ...
              _t(
                ...
                this._showSchedule &&
                  !this._showCalendar &&
                  e.resources &&
                  _t("div", { className: "mbsc-schedule-time-col" }),
                _t(
                  "div",
                  {
                    className:
    ...
    Ii = ((oa._selector = "[mbsc-calendar-next]"), ca),
    Hi = ((ra._selector = "[mbsc-calendar-prev]"), oa),
    Oi = ((la._selector = "[mbsc-calendar-today]"), ra),
    Pi = ((ca._selector = "[mbsc-calendar-nav]"), la),
    zi = bt(Hi),
    Ri = bt(Oi),
    Yi = bt(Pi),
    Ui = bt(Ii),
    ...
    Wi = (function (e) {
      ...
      return (
        n(t, e), (t._selector = "[mbsc-draggable]"), (t._renderOpt = Fi), t
      );
    })(Ai),
    Vi = bt(Wi, Fi),
    Bi = bt(Li, Ni);
  gt(Ii),
    ...
    (e.momentTimezone = si),
    (e.options = y),
    (e.outlookCalendarSync = Ln),
    (e.parseDate = an),
    (e.platform = x),
    (e.registerComponent = gt),
